...
void main() {
  ...
  group('FSD1: WITH FlexSchemeData ', () {
    ...
    // Do identity tests
    test('FSD1.01a: GIVEN same FlexSchemeData objects '
        'EXPECT them to be equal', () {
      expect(m1, equals(m1));
    });
    test('FSD1.01b: GIVEN same FlexSchemeData objects '
        'EXPECT them to have identity', () {
      expect(identical(m1, m1), true);
    });
    test('FSD1.01c: GIVEN two equal FlexSchemeData objects '
        'EXPECT them to have equality', () {
      expect(m1, equals(m2));
    });
    test('FSD1.01d: GIVEN two equal FlexSchemeData objects '
        'EXPECT them to have identity', () {
    ...
    test('FSD1.02a: GIVEN none equal FlexSchemeData objects '
        'EXPECT them to be unequal', () {
      expect(m1, isNot(m3));
    });
    test('FSD1.02b: GIVEN none equal FlexSchemeData objects '
    ...
    //**************************************************************************
    test('FSD1.03: GIVEN FlexSchemeData object with default Material scheme '
        'EXPECT to find it in FlexColor.schemes[FlexScheme.material]', () {
      expect(FlexColor.schemes[FlexScheme.material], m1);
    });
    test('FSD1.04: GIVEN FlexSchemeData object with default Material scheme '
    ...
    test('FSD1.05: GIVEN FlexSchemeData object with default Material scheme '
    ...
    //**************************************************************************
    test('FSD1.09a: GIVEN a FlexSchemeData object EXPECT it to be equal to '
    ...
    test('FSD1.09b: GIVEN a FlexSchemeData object EXPECT it to be unchanged '
    ...
    test('FSD1.11: Test toString implemented via debugFillProperties '
    ...
    test('FSD1.12: Test toStringShort implemented via debugFillProperties '
        'EXPECT exact short printout.', () {
      expect(m1.toStringShort(), equalsIgnoringHashCodes('FlexSchemeData#00000'));
    });
