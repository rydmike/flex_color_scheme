    ...
    test(
      ...
      expect(
        FlexThemeData.light(
          ...
          primaryVariant: FlexColor.indigo.light.primaryContainer,
          secondary: FlexColor.indigo.light.secondary,
          secondaryVariant: FlexColor.indigo.light.secondaryContainer,
      ...
      expect(
        FlexThemeData.dark(
          ...
          primaryVariant: FlexColor.indigo.dark.primaryContainer,
          secondary: FlexColor.indigo.dark.secondary,
          secondaryVariant: FlexColor.indigo.dark.secondaryContainer,
