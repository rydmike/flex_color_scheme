...
void main() {
  ...
  group('FCS7: WITH FlexColorScheme.toTheme ', () {
    ...
    test('FCS7.00-Default: GIVEN FlexColorScheme.light() made with default '
      ...
      expect(
        FlexColorScheme.light(useMaterial3: false).toScheme.toString(minLevel: DiagnosticLevel.fine),
    ...
    final ColorScheme schemeLight = ColorScheme(
      brightness: Brightness.light,
      primary: const Color(0xff6200ee),
      onPrimary: const Color(0xffffffff),
      primaryContainer: const Color(0xffbb86fc),
      onPrimaryContainer: const Color(0xff000000),
      primaryFixed: _fixedColor(const Color(0xff6200ee)),
      primaryFixedDim: _fixedDimColor(const Color(0xff6200ee)),
      onPrimaryFixed: _onFixedColor(const Color(0xff6200ee)),
      onPrimaryFixedVariant: _onFixedVariantColor(const Color(0xff6200ee)),
      secondary: const Color(0xff03dac6),
      onSecondary: const Color(0xff000000),
      secondaryContainer: const Color(0xffcefaf8),
      onSecondaryContainer: const Color(0xff000000),
      secondaryFixed: _fixedColor(const Color(0xff03dac6)),
      secondaryFixedDim: _fixedDimColor(const Color(0xff03dac6)),
      onSecondaryFixed: _onFixedColor(const Color(0xff03dac6)),
      onSecondaryFixedVariant: _onFixedVariantColor(const Color(0xff03dac6)),
      tertiary: const Color(0xff018786),
      onTertiary: const Color(0xffffffff),
      tertiaryContainer: const Color(0xffa4f1ef),
      onTertiaryContainer: const Color(0xff000000),
      tertiaryFixed: _fixedColor(const Color(0xff018786)),
      tertiaryFixedDim: _fixedDimColor(const Color(0xff018786)),
      onTertiaryFixed: _onFixedColor(const Color(0xff018786)),
      onTertiaryFixedVariant: _onFixedVariantColor(const Color(0xff018786)),
    ...
    test('FCS7.03-Raw-scheme-light: GIVEN FlexColorScheme() made with '
      ...
      testColorSchemeEquality(
        FlexColorScheme.light(useMaterial3: false).toScheme,
        FlexColorScheme(colorScheme: schemeLight, useMaterial3: false).toScheme,
        threshold: 0.002,
      );
    });
    ...
    test('FCS7.04-Raw-scheme-light: GIVEN FlexColorScheme() made with '
        ...
        ' v4.2.0 test case.', () {
      expect(
        FlexColorScheme(colorScheme: schemeLight, useMaterial3: false).toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(
          FlexColorScheme.light(useMaterial3: false).toTheme.toString(minLevel: DiagnosticLevel.fine),
        ),
      );
    ...
    test('FCS7.05-Default-scheme-light-STING: GIVEN FlexColorScheme() made with '
      ...
      testColorSchemeEquality(
        const FlexColorScheme(colorScheme: ColorScheme.light(), useMaterial3: false).toScheme,
        FlexColorScheme.light(colorScheme: const ColorScheme.light(), useMaterial3: false).toScheme,
      );
    });
    ...
    final ColorScheme schemeDark = ColorScheme(
      ...
      tertiaryContainer: const Color(0xff003e3e),
    ...
    test('FCS7.06s-Raw-scheme-dark: GIVEN FlexColorScheme() made with '
      ...
      testColorSchemeEquality(
        FlexColorScheme.dark(useMaterial3: false).toScheme,
        FlexColorScheme(colorScheme: schemeDark, useMaterial3: false).toScheme,
        threshold: 0.004,
      );
    });
    ...
    test('FCS7.06t-Raw-scheme-dark: GIVEN FlexColorScheme() made with '
        ...
        'correcting on error. v4.2.0 test case', () {
      expect(
        FlexColorScheme(colorScheme: schemeDark, useMaterial3: false).toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(
          FlexColorScheme.dark(useMaterial3: false).toTheme.toString(minLevel: DiagnosticLevel.fine),
        ),
      );
    ...
    final FlexColorScheme rawHcLight = FlexColorScheme(
      useMaterial3: false,
      colorScheme: ColorScheme(
        ...
        onPrimaryContainer: const Color(0xff000000),
        primaryFixed: _fixedColor(const Color(0xff0000ba)),
        primaryFixedDim: _fixedDimColor(const Color(0xff0000ba)),
        onPrimaryFixed: _onFixedColor(const Color(0xff0000ba)),
        onPrimaryFixedVariant: _onFixedVariantColor(const Color(0xff0000ba)),
        secondary: const Color(0xff66fff9),
        onSecondary: const Color(0xff000000),
        secondaryContainer: const Color(0xffc8f9f7),
        onSecondaryContainer: const Color(0xff000000),
        secondaryFixed: _fixedColor(const Color(0xff66fff9)),
        secondaryFixedDim: _fixedDimColor(const Color(0xff66fff9)),
        onSecondaryFixed: _onFixedColor(const Color(0xff66fff9)),
        onSecondaryFixedVariant: _onFixedVariantColor(const Color(0xff66fff9)),
        tertiary: const Color(0xff018786),
        onTertiary: const Color(0xffffffff),
        tertiaryContainer: const Color(0xffb3f1f0),
        onTertiaryContainer: const Color(0xff000000),
        tertiaryFixed: _fixedColor(const Color(0xff018786)),
        tertiaryFixedDim: _fixedDimColor(const Color(0xff018786)),
        onTertiaryFixed: _onFixedColor(const Color(0xff018786)),
    ...
    test('FCS7.08-Scheme-hc-light: GIVEN raw FlexColorScheme() made with '
      ...
      testColorSchemeEquality(
        rawHcLight.toScheme,
        FlexColorScheme.light(scheme: FlexScheme.materialHc, useMaterial3: false).toScheme,
        threshold: 0.003,
      );
    });
    ...
    final ColorScheme hcDarkWithLight = ColorScheme(
      brightness: Brightness.dark,
      primary: const Color(0xffaaaaaa),
      onPrimary: const Color(0xffaaaaaa),
      primaryContainer: const Color(0xffaaaaaa),
      onPrimaryContainer: const Color(0xffaaaaaa),
      secondary: const Color(0xff66fff9),
      onSecondary: const Color(0xffaaaaaa),
      secondaryContainer: const Color(0xffaaaaaa),
      onSecondaryContainer: const Color(0xffaaaaaa),
      tertiary: const Color(0xffaaaaaa),
      onTertiary: const Color(0xffaaaaaa),
      tertiaryContainer: const Color(0xffaaaaaa),
      onTertiaryContainer: const Color(0xffaaaaaa),
      error: const Color(0xffaaaaaa),
      onError: const Color(0xffaaaaaa),
      errorContainer: const Color(0xffaaaaaa),
      onErrorContainer: const Color(0xffaaaaaa),
      surface: const Color(0xffffffff),
      onSurface: const Color(0xff000000),
    ...
    final FlexColorScheme hcLightWithLight = FlexColorScheme(
      useMaterial3: false,
    ...
    final FlexColorScheme hcLight = FlexColorScheme.light(scheme: FlexScheme.materialHc, useMaterial3: false);
    ...
    test('FCS7.11-Scheme-hc-light-props: GIVEN FlexColorScheme() made with '
        ...
        'FlexColorScheme.light(scheme: FlexScheme.materialHc) '
        'v4.2.0 test case.', () {
      testColorSchemeEquality(hcLightWithLight.toScheme, hcLight.toScheme, threshold: 0.003);
    });
    test('FCS7.13-Theme-hc-light: GIVEN FlexColorScheme() made with '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(hcLight.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });

    // Dark default color scheme
    final FlexColorScheme darkDefault = FlexColorScheme(
      colorScheme: ColorScheme(
        brightness: Brightness.dark,
        ...
        onPrimaryContainer: const Color(0xff000000),
        primaryFixed: _fixedColor(const Color(0xffefb7ff)),
        primaryFixedDim: _fixedDimColor(const Color(0xffefb7ff)),
        onPrimaryFixed: _onFixedColor(const Color(0xffefb7ff)),
        onPrimaryFixedVariant: _onFixedVariantColor(const Color(0xffefb7ff)),
        secondary: const Color(0xff66fff9),
        onSecondary: const Color(0xff000000),
        ...
        onTertiaryContainer: const Color(0xff000000),
        tertiaryFixed: _fixedColor(const Color(0xff66fff9)),
        tertiaryFixedDim: _fixedDimColor(const Color(0xff66fff9)),
        onTertiaryFixed: _onFixedColor(const Color(0xff66fff9)),
        onTertiaryFixedVariant: _onFixedVariantColor(const Color(0xff66fff9)),
        error: const Color(0xff9b374d),
        onError: const Color(0xff000000),
        errorContainer: FlexColor.darkErrorContainer(const Color(0xff9b374d)),
        onErrorContainer: const Color(0xffffffff),
        surface: const Color(0xff121212),
        onSurface: const Color(0xffffffff),
        surfaceDim: const Color(0xff060606),
    ...
    test('FCS7.14a-Scheme-hc-dark: GIVEN FlexColorScheme() made with '
      ...
      testColorSchemeEquality(darkDefault.toScheme, darkFactoryDefault.toScheme);
    });
    ...
    test('FCS7.14b-Theme-hc-dark: GIVEN FlexColorScheme() made with '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(darkFactoryDefault.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });

    // Raw High contrast dark scheme
    final FlexColorScheme hcDarkDefault = FlexColorScheme(
      colorScheme: ColorScheme(
        brightness: Brightness.dark,
        primary: const Color(0xffefb7ff),
        onPrimary: const Color(0xff000000),
        primaryContainer: const Color(0xff8a61db),
        onPrimaryContainer: const Color(0xffffffff),
        primaryFixed: _fixedColor(const Color(0xff0000ba)),
        primaryFixedDim: _fixedDimColor(const Color(0xff0000ba)),
        onPrimaryFixed: _onFixedColor(const Color(0xff0000ba)),
        ...
        secondary: const Color(0xff66fff9),
        onSecondary: const Color(0xff000000),
        secondaryContainer: const Color(0xff00504d),
        onSecondaryContainer: const Color(0xffffffff),
        secondaryFixed: _fixedColor(const Color(0xff66fff9)),
        secondaryFixedDim: _fixedDimColor(const Color(0xff66fff9)),
        onSecondaryFixed: _onFixedColor(const Color(0xff66fff9)),
        ...
        tertiary: const Color(0xff66fff9),
        onTertiary: const Color(0xff000000),
        tertiaryContainer: const Color(0xff043232),
        onTertiaryContainer: const Color(0xffffffff),
        tertiaryFixed: _fixedColor(const Color(0xff018786)),
        tertiaryFixedDim: _fixedDimColor(const Color(0xff018786)),
        onTertiaryFixed: _onFixedColor(const Color(0xff018786)),
    ...
    test('FCS7.15a-Scheme-hc-dark: GIVEN Raw FlexColorScheme() made with '
      ...
      testColorSchemeEquality(hcDarkDefault.toScheme, hcDarkFactoryDefault.toScheme, threshold: 0.003);
    });
    ...
    test('FCS7.15b-Theme-hc-dark: GIVEN GIVEN Raw FlexColorScheme() made with '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(hcDarkFactoryDefault.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });

    // A color scheme that, that we will use as "wrong" input
    // to override and expect correct result via the overrides.
    final ColorScheme hcLightWithDark = ColorScheme(
      brightness: Brightness.light,
      primary: const Color(0xffefb7ff),
      onPrimary: const Color(0xffaaaaaa),
      primaryContainer: const Color(0xffaaaaaa),
    ...
    final FlexColorScheme rawHcFCS = FlexColorScheme(
    ...
    test('FCS7.17-toScheme-hc-dark: GIVEN FlexColorScheme() made with '
        ...
        'and minimal colors', () {
      testColorSchemeEquality(rawHcFCS.toScheme, hcDarkFactoryDefault.toScheme, threshold: 0.003);
    });
    ...
    final FlexColorScheme fcsRawHcDarkScheme = FlexColorScheme(
      colorScheme: ColorScheme(
        brightness: Brightness.dark,
        primary: const Color(0xffefb7ff),
        onPrimary: const Color(0xff000000),
        ...
        onTertiaryContainer: const Color(0xff000000),
        tertiaryFixed: _fixedColor(const Color(0xff03dac6)),
        tertiaryFixedDim: _fixedDimColor(const Color(0xff03dac6)),
        onTertiaryFixed: _onFixedColor(const Color(0xff03dac6)),
        onTertiaryFixedVariant: _onFixedVariantColor(const Color(0xff03dac6)),
        error: const Color(0xff9b374d),
        onError: const Color(0xffffffff),
        errorContainer: FlexColor.darkErrorContainer(const Color(0xff9b374d)),
        onErrorContainer: const Color(0xffffffff),
    ...
    final FlexColorScheme fcsRawHcDarkProps = FlexColorScheme.dark(
      primary: const Color(0xffefb7ff),
      primaryContainer: const Color(0xffbe9eff),
      secondary: const Color(0xff66fff9),
      secondaryContainer: const Color(0xff66fff9),
    ...
    test('FCS7.19-Scheme-hc-dark-M2-prop: GIVEN FlexColorScheme() made with '
      ...
      testColorSchemeEquality(fcsRawHcDarkScheme.toScheme, fcsRawHcDarkProps.toScheme, threshold: 0.002);
    });
    test('FCS7.19-ThemeData-hc-dark-M2-string: GIVEN FlexColorScheme() made with '
        ...
        'dark factory and color overrides. v4.2.0 test case.', () {
      expect(
        fcsRawHcDarkScheme.toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(fcsRawHcDarkProps.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });

    final FlexColorScheme fcsRawHcDarkSchemeM3 = FlexColorScheme(
      colorScheme: ColorScheme(
        brightness: Brightness.dark,
        primary: const Color(0xffefb7ff),
        onPrimary: const Color(0xff000000),
    ...
    final FlexColorScheme fcsRawHcDarkPropsM3 = FlexColorScheme.dark(
      primary: const Color(0xffefb7ff),
      primaryContainer: const Color(0xffbe9eff),
      secondary: const Color(0xff66fff9),
      secondaryContainer: const Color(0xff66fff9),
    ...
    test('FCS7.20-Scheme-hc-dark-M3-prop: GIVEN FlexColorScheme() made with '
        ...
        'dark factory and color overrides. v4.2.0 test case.', () {
      testColorSchemeEquality(fcsRawHcDarkSchemeM3.toScheme, fcsRawHcDarkPropsM3.toScheme, threshold: 0.003);
    });
    ...
    test('FCS7.20-Scheme-hc-dark-M3: GIVEN FlexColorScheme() made with '
        ...
        'dark factory and color overrides. v4.2.0 test case.', () {
      expect(
        fcsRawHcDarkSchemeM3.toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(fcsRawHcDarkPropsM3.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });
    ...
    test('FCS7.28SwapL: GIVEN FlexColorScheme.light(swapColors: true) EXPECT it '
      ...
      expect(
        FlexColorScheme.light(useMaterial3: false, swapColors: true).toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(
          FlexColorScheme.light(
            useMaterial3: false,
            colors: const FlexSchemeColor(
    ...
    test('FCS7.29SwapD: GIVEN FlexColorScheme.dark(swapColors: true) EXPECT it '
      ...
      expect(
        FlexColorScheme.dark(useMaterial3: false, swapColors: true).toTheme.toString(minLevel: DiagnosticLevel.fine),
        equalsIgnoringHashCodes(
          FlexColorScheme.dark(
            useMaterial3: false,
            colors: const FlexSchemeColor(
    ...
    test('FCS7.33D: GIVEN a FlexColorScheme.dark made with colors '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(
          FlexColorScheme.dark(scheme: FlexScheme.material).toTheme.toString(minLevel: DiagnosticLevel.fine),
        ),
      );
    });
    test('FCS7.34D: GIVEN a FlexColorScheme.dark made with scheme '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(FlexColorScheme.dark().toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });
    ...
    test('FCS7.01-props: GIVEN a FlexColorScheme theme with Material scheme '
        ...
        'light.', () {
      testColorSchemeEquality(themeLight.colorScheme, lightScheme);
    });
    // themeDark = Default material dark scheme colors.
    ...
    test('FCS7.04: GIVEN a FlexColorScheme theme with Material3 scheme dark '
      ...
      expect(themeDark.appBarTheme.backgroundColor, equals(const Color(0xff121212)));
    });

    test('FCS7.05: GIVEN a FlexColorScheme theme with null VisualDensity input '
        'EXPECT VisualDensity().', () {
      expect(themeLight.visualDensity, equals(VisualDensity.standard));
    });
    test('FCS7.06: GIVEN a FlexColorScheme M2 theme with null Typography input '
        'EXPECT Typography.material2018.', () {
      expect(themeLight.typography, equals(Typography.material2018(platform: defaultTargetPlatform)));
    });
    ...
    test('FCS7.09: GIVEN a FlexColorScheme theme with Material scheme light '
      ...
      expect(themeLight.primaryColorDark, equals(themeLight.colorScheme.primary.blend(Colors.black, 40)));
    });
    test('FCS7.10: GIVEN a FlexColorScheme theme with Material scheme dark '
        'colors EXPECT primaryColorDark equality with '
        'blend(Colors.black, 45).', () {
      expect(themeDark.primaryColorDark, equals(themeDark.colorScheme.primary.blend(Colors.black, 45)));
    });
    ...
    test('FCS7.11: GIVEN a FlexColorScheme theme with Material scheme light '
      ...
      expect(themeLight.primaryColorLight, equals(themeLight.colorScheme.primary.blend(Colors.white, 40)));
    });
    test('FCS7.12: GIVEN a FlexColorScheme theme with Material scheme dark '
        'colors EXPECT primaryColorLight equality with '
        '.blend(Colors.white, 35).', () {
      expect(themeDark.primaryColorLight, equals(themeDark.colorScheme.primary.blend(Colors.white, 35)));
    });
    ...
    test('FCS7.13: GIVEN a FlexColorScheme theme with Material scheme light '
      ...
      expect(themeLight.secondaryHeaderColor, equals(themeLight.colorScheme.primary.blend(Colors.white, 80)));
    });
    test('FCS7.14: GIVEN a FlexColorScheme theme with Material scheme dark '
        'colors EXPECT secondaryHeaderColor equality with '
        'blend(Colors.black, 60).', () {
      expect(themeDark.secondaryHeaderColor, equals(themeDark.colorScheme.primary.blend(Colors.black, 60)));
    });
    ...
    test('FCS7.16: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
        ...
        'colorScheme.surface.', () {
      expect(tLightL.appBarTheme.backgroundColor, equals(tLightL.colorScheme.surface));
    });
    test('FCS7.17: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexAppBarStyle.surface EXPECT appbar theme color '
        'colorScheme.surface.', () {
      expect(tDarkL.appBarTheme.backgroundColor, equals(tDarkL.colorScheme.surface));
    });
    ...
    test('FCS7.26: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightL.indicatorColor, isSameColorAs(tLightL.colorScheme.primary));
    });
    ...
    test('FCS7.28: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightL.tabBarTheme.labelColor, isSameColorAs(tLightL.colorScheme.primary));
    });
    test('FCS7.29: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexTabBarStyle.forAppBar and FlexAppBarStyle.primary EXPECT '
        'TabBarTheme.labelColor primary.', () {
      expect(tDarkL.tabBarTheme.labelColor, isSameColorAs(tDarkL.colorScheme.primary));
    });
    ...
    test('FCS7.32: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightM.appBarTheme.backgroundColor, isSameColorAs(FlexColor.materialLightSurface));
    });
    test('FCS7.33: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        ...
        'colorScheme.primary.', () {
      expect(tDarkM.appBarTheme.backgroundColor, isSameColorAs(tDarkM.colorScheme.primary));
    });
    ...
    test('FCS7.46: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
      ...
      expect(tDarkM.tabBarTheme.unselectedLabelColor, isSameColorAs(Colors.black87.withAlpha(0xB2)));
    });
    ...
    test('FCS7.47: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightS.appBarTheme.backgroundColor, equals(tLightS.colorScheme.tertiary));
    });
    test('FCS7.48: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexAppBarStyle.material EXPECT appbar theme color '
        'default material dark surface.', () {
      expect(tDarkS.appBarTheme.backgroundColor, equals(FlexColor.materialDarkSurface));
    });
    ...
    test('FCS7.61: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightS.tabBarTheme.unselectedLabelColor, isSameColorAs(Colors.white.withAlpha(0xB2)));
    });
    test('FCS7.62: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexTabBarStyle.forAppBar and FlexAppBarStyle.primary EXPECT '
        'TabBarTheme.unselectedLabelColor white.withAlpha(0xB2).', () {
      expect(tDarkS.tabBarTheme.unselectedLabelColor, isSameColorAs(Colors.white.withAlpha(0xB2)));
    });
    ...
    test('FCS7.63: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
      ...
      expect(tLightH.appBarTheme.backgroundColor, equals(tLightH.colorScheme.surfaceContainerLow));
    });
    test('FCS7.64: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexAppBarStyle.background EXPECT appbar theme color '
        'colorScheme.surfaceContainerLow.', () {
      expect(tDarkH.appBarTheme.backgroundColor, equals(tDarkH.colorScheme.surfaceContainerLow));
    });
    ...
    test('FCS7.73: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
        'WITH FlexTabBarStyle.forAppBar and FlexAppBarStyle.material EXPECT '
        'indicator color primary.', () {
      expect(tLightH.indicatorColor, isSameColorAs(tLightH.colorScheme.primary));
    });
    ...
    test('FCS7.75: GIVEN a FlexColorScheme.light theme FROM scheme "material" '
        'WITH FlexTabBarStyle.forAppBar and FlexAppBarStyle.material EXPECT '
        'TabBarTheme.labelColor primary.', () {
      expect(tLightH.tabBarTheme.labelColor, isSameColorAs(tLightH.colorScheme.primary));
    });
    test('FCS7.76: GIVEN a FlexColorScheme.dark theme FROM scheme "material" '
        'WITH FlexTabBarStyle.forAppBar and FlexAppBarStyle.primary EXPECT '
        'TabBarTheme.labelColor primary.', () {
      expect(tDarkH.tabBarTheme.labelColor, isSameColorAs(tDarkH.colorScheme.primary));
    });
    ...
    final ColorScheme realRawSchemeLight = ColorScheme(
      ...
      surfaceContainerLowest: surf.surfaceContainerLowest,
      surfaceContainerLow: surf.surfaceContainerLow,
      surfaceContainer: surf.surfaceContainer,
      surfaceContainerHigh: surf.surfaceContainerHigh,
      surfaceContainerHighest: surf.surfaceContainerHighest,
      onSurfaceVariant: const Color(0xff000000),
      //
      errorContainer: FlexColor.lightErrorContainer(const Color(0xff790000)),
      onErrorContainer: const Color(0xff000000),
    ...
    test('FCS7.79a-props: GIVEN a Equal Raw and FlexColorScheme.light '
      ...
      testColorSchemeEquality(fcsLightH2.toScheme, fcsLightH2Raw.toScheme, threshold: 0.000);
    });
    ...
    test('FCS7.79c-props: GIVEN a Equal Raw and FlexColorScheme.light with '
      ...
      testColorSchemeEquality(fcsLightH2.toScheme, fcsLightH2RealRaw.toScheme, threshold: 0.000);
    });
    test('FCS7.79d-object: GIVEN a Equal Raw and FlexColorScheme.light with '
        'heavy branding and 2 colors EXPECT equal objects.', () {
      expect(fcsLightH2, equals(fcsLightH2RealRaw));
    });
    ...
    test('fcs appBarBackground = surfaceContainerLow darken5', () {
      expect(fcsDarkH2.appBarBackground, equals(surfD.surfaceContainerLow.darken(5)));
    });

    test('fcs dialogBackground = dialogBackground darken5', () {
      expect(fcsDarkH2.dialogBackground, equals(surfD.dialogBackground.darken(5)));
    });

    test('fcs dialogBackground hex = dialogBackground hextString darken5', () {
      expect(fcsDarkH2.dialogBackground?.hexCode, equals(surfD.dialogBackground.darken(5).hexCode));
    });

    test('dialogBackground Raw', () {
      expect(fcsDarkH2Raw.dialogBackground, equals(surfD.dialogBackground.darken(5)));
    });
    ...
    test('FCS7.80a-scheme-thresh: GIVEN a Equal Raw and FlexColorScheme.dark with '
      ...
      testColorSchemeEquality(fcsDarkH2.toScheme, fcsDarkH2Raw.toScheme, threshold: 0.000);
    });
    ...
    test('FCS7.80a-scheme: GIVEN a Equal Raw and FlexColorScheme.dark with '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(fcsDarkH2Raw.toScheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });
    test('FCS7.80b-scheme: GIVEN a Equal Raw and FlexColorScheme.dark with '
        'blend 30 and 2 colors and true black EXPECT equal '
        'scheme objects.', () {
      expect(fcsDarkH2.toScheme, equals(fcsDarkH2Raw.toScheme));
    });
    test('FCS7.80c-fcs: GIVEN a Equal Raw and FlexColorScheme.dark with '
      ...
      expect(fcsDarkH2 != fcsDarkH2Raw, false);
    });
    ...
    test('FCS7.80e-object: GIVEN a Equal Raw and FlexColorScheme.dark with '
      ...
      expect(fcsDarkH2, equals(fcsDarkH2Raw));
    });
    test('FCS7.80f-string: GIVEN a Raw and FlexColorScheme.dark with blend '
      ...
      expect(
        ...
        equalsIgnoringHashCodes(fcsDarkH2Raw.toTheme.toString(minLevel: DiagnosticLevel.fine)),
      );
    });

    final ThemeData tLightH3 =
        FlexColorScheme.light(
          colors: FlexColor.schemes[FlexScheme.mandyRed]!.light,
          surfaceMode: FlexSurfaceMode.highScaffoldLowSurfaces,
          blendLevel: 35,
    ...
    test('FCS7.81: GIVEN a FlexColorScheme.light with heavy branding and 3 '
      ...
      expect(tLightH3, tLightH3.copyWith(primaryColor: FlexColor.mandyRedLightPrimary));
    });
    test('FCS7.82: GIVEN a FlexColorScheme.dark with heavy branding and '
      ...
      expect(tDarkH3, tDarkH3.copyWith(primaryColor: FlexColor.mandyRedDarkPrimary));
    });
    ...
    final ThemeData tLightHb =
        FlexColorScheme.light(
          ...
          transparentStatusBar: false,
          bottomAppBarElevation: 1,
          subThemesData: const FlexSubThemesData(defaultRadius: 8, tabBarIndicatorSchemeColor: SchemeColor.secondary),
        ).toTheme;
    ...
    final ThemeData tDarkHb =
        FlexColorScheme.dark(
          ...
          transparentStatusBar: false,
          bottomAppBarElevation: 1,
          subThemesData: const FlexSubThemesData(defaultRadius: 12, tabBarIndicatorSchemeColor: SchemeColor.error),
        ).toTheme;
    ...
    test('FCS7.83: GIVEN a FlexColorScheme.light with given options '
      ...
      expect(tLightC.appBarTheme.backgroundColor, FlexColor.mandyRed.light.tertiary);
      expect(tLightC.appBarTheme.elevation, 2);
    });

    final ThemeData tDarkC =
        FlexColorScheme.dark(
          colors: FlexColor.schemes[FlexScheme.mandyRed]!.dark,
          surfaceMode: FlexSurfaceMode.custom,
          blendLevel: 20,
    ...
    test('FCS7.84: GIVEN a FlexColorScheme.dark with given options '
      ...
      expect(tDarkC.appBarTheme.backgroundColor, FlexColor.mandyRed.dark.tertiary);
      expect(tDarkC.appBarTheme.elevation, 4);
    });

    // With surface and background colors defined, and light is white
    final ThemeData tLightC2 =
        FlexColorScheme.light(
          colors: FlexColor.schemes[FlexScheme.mandyRed]!.light,
          surfaceMode: FlexSurfaceMode.custom,
          blendLevel: 0,
    ...
    test('FCS7.85: GIVEN a FlexColorScheme.light with more options '
      ...
      expect(tLightC2, equals(tLightC2.copyWith(applyElevationOverlayColor: false)));
    });
    test('FCS7.86: GIVEN a FlexColorScheme.dark with more options '
        'like custom surface and background '
        'EXPECT OK and identical to copy.', () {
      expect(tDarkC2, equals(tDarkC2.copyWith(applyElevationOverlayColor: true)));
    });
    ...
    final TextTheme fLightT = FlexColorScheme.light(onSurface: Colors.black).toTheme.textTheme;
    ...
    //
    // Flex default TextTheme light
    final TextTheme fLightP = FlexColorScheme.light(surface: Colors.white).toTheme.primaryTextTheme;
    ...
    final TextTheme fDarkT = FlexColorScheme.dark(onSurface: Colors.white).toTheme.textTheme;
    final TextTheme nDarkT = ThemeData(brightness: Brightness.dark, typography: Typography.material2021()).textTheme;
    ...
    // part of the test.
    final TextTheme fDarkP = FlexColorScheme.dark(useMaterial3: false).toTheme.primaryTextTheme;
    final Color nDarkPColor = FlexColorScheme.dark(useMaterial3: false).toTheme.primaryColor;
    final TextTheme nDarkP =
        ThemeData(
          useMaterial3: false,
          brightness: Brightness.dark,
    ...
    const TextTheme customText = TextTheme(
      titleLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.w500, letterSpacing: 0.15, height: 24 / 20),
      headlineSmall: TextStyle(fontSize: 24, fontWeight: FontWeight.w500, letterSpacing: 0.15),
      headlineMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, letterSpacing: 0.15),
      titleSmall: TextStyle(fontSize: 17, fontWeight: FontWeight.w500, letterSpacing: 0.25, height: 20 / 17),
      bodyLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, letterSpacing: 0.25, height: 20 / 14),
      bodyMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, letterSpacing: 0.5),
    );
    ...
    final ThemeData nLightTD = ThemeData(textTheme: customText, primaryTextTheme: customPrimText);
    ...
    test('FCS7.99 null: GIVEN a FlexColorScheme.light with no centerTitle '
      ...
      final ThemeData tLAppBarCenterNull = FlexColorScheme.light(scheme: FlexScheme.flutterDash).toTheme;
    ...
    test('FCS7.100a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.colorScheme.secondary, equals(FlexColor.dashBlueLightSecondary));
      expect(theme.colorScheme.secondaryContainer, equals(FlexColor.dashBlueLightSecondaryContainer));
      expect(theme.colorScheme.tertiary, equals(FlexColor.dashBlueLightTertiary));
      expect(theme.colorScheme.tertiaryContainer, equals(FlexColor.dashBlueLightTertiaryContainer));
    });
    ...
    test('FCS7.100b GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.colorScheme.secondary, equals(FlexColor.blumineBlueLightTertiary));
      expect(theme.colorScheme.secondaryContainer, equals(FlexColor.blumineBlueLightTertiaryContainer));
      expect(theme.colorScheme.tertiary, equals(FlexColor.blumineBlueLightSecondary));
      expect(theme.colorScheme.tertiaryContainer, equals(FlexColor.blumineBlueLightSecondaryContainer));
    });
    // Test swapLegacyOnMaterial3 when using Material 3 - No swap result
    test('FCS7.100c GIVEN a FlexColorScheme.Dark with useMaterial3:true '
        ...
        'EXPECT no legacy swap - Dash does not swap', () {
      final ThemeData theme =
          FlexColorScheme.dark(scheme: FlexScheme.flutterDash, useMaterial3: true, swapLegacyOnMaterial3: true).toTheme;
      expect(theme.colorScheme.secondary, equals(FlexColor.dashBlueDarkSecondary));
      expect(theme.colorScheme.secondaryContainer, equals(FlexColor.dashBlueDarkSecondaryContainer));
      expect(theme.colorScheme.tertiary, equals(FlexColor.dashBlueDarkTertiary));
      expect(theme.colorScheme.tertiaryContainer, equals(FlexColor.dashBlueDarkTertiaryContainer));
    });
    // Test swapLegacyOnMaterial3 when using Material 3 - Swapped result
    test('FCS7.100d GIVEN a FlexColorScheme.Dark with useMaterial3:true '
        ...
        'EXPECT legacy swap - Blumine swaps', () {
      final ThemeData theme =
          FlexColorScheme.dark(scheme: FlexScheme.blumineBlue, useMaterial3: true, swapLegacyOnMaterial3: true).toTheme;
      expect(theme.colorScheme.secondary, equals(FlexColor.blumineBlueDarkTertiary));
      expect(theme.colorScheme.secondaryContainer, equals(FlexColor.blumineBlueDarkTertiaryContainer));
      expect(theme.colorScheme.tertiary, equals(FlexColor.blumineBlueDarkSecondary));
      expect(theme.colorScheme.tertiaryContainer, equals(FlexColor.blumineBlueDarkSecondaryContainer));
    });
    ...
    test('FCS7.101a GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      expect(theme.bottomSheetTheme.backgroundColor, equals(theme.colorScheme.surfaceContainerLow));
      expect(theme.bottomSheetTheme.modalBackgroundColor, equals(theme.colorScheme.surfaceContainerLow));
      expect(theme.bottomSheetTheme.elevation, equals(4));
      expect(theme.bottomSheetTheme.modalElevation, equals(8));
      expect(theme.bottomSheetTheme.clipBehavior, equals(null));
      expect(
    ...
    test('FCS7.101b GIVEN a FlexColorScheme.dark with useMaterial3:true '
      ...
      final ThemeData theme =
          FlexColorScheme.dark(
            ...
            useMaterial3: true,
            subThemesData: const FlexSubThemesData(bottomSheetClipBehavior: Clip.antiAlias),
          ).toTheme;
      ...
      expect(theme.bottomSheetTheme.backgroundColor, equals(bottomSheetColor));
      expect(theme.bottomSheetTheme.modalBackgroundColor, equals(bottomSheetModalColor));
      expect(theme.bottomSheetTheme.elevation, equals(1));
      expect(theme.bottomSheetTheme.modalElevation, equals(2));
      expect(theme.bottomSheetTheme.clipBehavior, equals(Clip.antiAlias));
      expect(
        theme.bottomSheetTheme.shape,
        equals(
          const RoundedRectangleBorder(
    ...
    test('FCS7.101c GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      final ColorScheme scheme = theme.colorScheme;
      expect(theme.bottomSheetTheme.backgroundColor, equals(scheme.surface));
      expect(theme.bottomSheetTheme.modalBackgroundColor, equals(scheme.surfaceContainer));
      expect(theme.bottomSheetTheme.elevation, equals(2));
      expect(theme.bottomSheetTheme.modalElevation, equals(12));
      expect(theme.bottomSheetTheme.clipBehavior, equals(Clip.hardEdge));
      expect(
        theme.bottomSheetTheme.shape,
        equals(
          const RoundedRectangleBorder(
    ...
    test('FCS7.101d GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.bottomSheetTheme.backgroundColor, equals(bottomSheetColor));
      expect(theme.bottomSheetTheme.modalBackgroundColor, equals(bottomSheetModalColor));
      expect(theme.bottomSheetTheme.elevation, equals(6));
      expect(theme.bottomSheetTheme.modalElevation, equals(10));
      expect(theme.bottomSheetTheme.clipBehavior, equals(Clip.antiAliasWithSaveLayer));
      expect(
        theme.bottomSheetTheme.shape,
        equals(
          const RoundedRectangleBorder(
    ...
    test('FCS7.101d MODAL GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.bottomSheetTheme.modalBackgroundColor, equals(bottomSheetModalColor));
      expect(theme.bottomSheetTheme.modalElevation, equals(10));
      expect(theme.bottomSheetTheme.clipBehavior, equals(Clip.none));
      expect(
        theme.bottomSheetTheme.shape,
        equals(
          const RoundedRectangleBorder(
    ...
    test('FCS7.102a GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      expect(theme.popupMenuTheme.elevation, equals(6.0));
      expect(theme.popupMenuTheme.textStyle, equals(null));
      expect(theme.popupMenuTheme.shape, equals(null));
    });
    ...
    test('FCS7.102b GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.popupMenuTheme.color, equals(null));
      expect(theme.popupMenuTheme.elevation, equals(3.0));
      expect(theme.popupMenuTheme.textStyle, equals(null));
      expect(theme.popupMenuTheme.shape, equals(null));
    });
    ...
    test('FCS7.102c GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ThemeData theme =
          FlexColorScheme.light(
            scheme: FlexScheme.materialBaseline,
            useMaterial3: false,
            subThemesData: const FlexSubThemesData(popupMenuElevation: 5, popupMenuRadius: 8, popupMenuOpacity: 0.95),
          ).toTheme;
      expect(theme.popupMenuTheme.color, equals(theme.colorScheme.surface.withValues(alpha: 0.95)));
      expect(theme.popupMenuTheme.elevation, equals(5.0));
      expect(theme.popupMenuTheme.textStyle?.color, equals(Colors.black));
      expect(
        theme.popupMenuTheme.shape,
        equals(const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(8.0)))),
      );
    });
    ...
    test('FCS7.102d GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ThemeData theme =
          FlexColorScheme.light(
            scheme: FlexScheme.materialBaseline,
            useMaterial3: true,
            subThemesData: const FlexSubThemesData(popupMenuElevation: 6, popupMenuRadius: 10, popupMenuOpacity: 0.9),
          ).toTheme;
      ...
      expect(theme.popupMenuTheme.color, equals(background));
      expect(theme.popupMenuTheme.elevation, equals(6.0));
      expect(theme.popupMenuTheme.textStyle?.color, equals(Colors.black));
      expect(
        theme.popupMenuTheme.shape,
        equals(const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10.0)))),
      );
    });
    ...
    test('FCS7.102d GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      expect(theme.popupMenuTheme.color, equals(theme.colorScheme.primaryContainer.withValues(alpha: 0.98)));
      expect(theme.popupMenuTheme.elevation, equals(12));
      expect(theme.popupMenuTheme.textStyle?.color, equals(Colors.white));
      expect(
        theme.popupMenuTheme.shape,
        equals(const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(11.0)))),
      );
    });
    ...
    test('FCS7.102e GIVEN a FlexColorScheme.dark with useMaterial3:true '
      ...
      expect(theme.popupMenuTheme.color, equals(background));
      expect(theme.popupMenuTheme.elevation, equals(2.0));
      expect(theme.popupMenuTheme.textStyle?.color, equals(refTheme.colorScheme.onSurface));
      expect(
        theme.popupMenuTheme.shape,
        equals(const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(9.0)))),
      );
    });
    // Test custom PopupMenu theming, with custom background, dark M2.
    test('FCS7.102d GIVEN a FlexColorScheme.dark with useMaterial3:false '
    ...
    test('FCS7.103a GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      expect(theme.toggleButtonsTheme.borderWidth, equals(1));
      ...
      expect(border?.resolve(<WidgetState>{WidgetState.selected}).borderSide.width, equals(1));
      expect(border?.resolve(<WidgetState>{}).borderSide.width, equals(1));
      // InputDecoration thick width
      expect(border?.resolve(<WidgetState>{WidgetState.focused}).borderSide.width, equals(2));
      expect(border?.resolve(<WidgetState>{WidgetState.focused, WidgetState.error}).borderSide.width, equals(2));
      expect(theme.inputDecorationTheme.border?.borderSide.width, equals(1));
      // OutlinedButton thin widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.selected})?.width, equals(1));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.hovered})?.width, equals(1));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.disabled})?.width, equals(1));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.focused})?.width, equals(1));
      // OutlinedButton thick widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.error})?.width, equals(2));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.pressed})?.width, equals(2));
    });
    test('FCS7.103b GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final WidgetStateInputBorder? border = theme.inputDecorationTheme.border as WidgetStateInputBorder?;
      // InputDecoration thin width
      expect(border?.resolve(<WidgetState>{WidgetState.disabled}).borderSide.width, equals(1));
      expect(border?.resolve(<WidgetState>{}).borderSide.width, equals(1));
      // InputDecoration thick width
      expect(border?.resolve(<WidgetState>{WidgetState.focused}).borderSide.width, equals(2));
      expect(border?.resolve(<WidgetState>{WidgetState.focused, WidgetState.error}).borderSide.width, equals(2));
      ...
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.selected})?.width, equals(null));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.hovered})?.width, equals(null));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.disabled})?.width, equals(null));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.focused})?.width, equals(null));
      // OutlinedButton thick widths, null in M3 which results in 1
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.error})?.width, equals(null));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.pressed})?.width, equals(null));
    });
    test('FCS7.103c GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ThemeData theme =
          FlexColorScheme.light(
            scheme: FlexScheme.materialBaseline,
            useMaterial3: false,
            subThemesData: const FlexSubThemesData(thinBorderWidth: 3, thickBorderWidth: 4),
          ).toTheme;
      // ToggleButtons thin width
      expect(theme.toggleButtonsTheme.borderWidth, equals(3));
      final WidgetStateInputBorder? border = theme.inputDecorationTheme.border as WidgetStateInputBorder?;
      // InputDecoration thin width
      expect(border?.resolve(<WidgetState>{WidgetState.disabled}).borderSide.width, equals(3));
      expect(border?.resolve(<WidgetState>{}).borderSide.width, equals(3));
      // InputDecoration thick width
      expect(border?.resolve(<WidgetState>{WidgetState.focused}).borderSide.width, equals(4));
      expect(border?.resolve(<WidgetState>{WidgetState.focused, WidgetState.error}).borderSide.width, equals(4));
      // TODO(rydmike): This is not expected, why do we get this? Study it!
      expect(theme.inputDecorationTheme.border?.borderSide.width, equals(1));
      // OutlinedButton thin widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.selected})?.width, equals(3));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.hovered})?.width, equals(3));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.disabled})?.width, equals(3));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.focused})?.width, equals(3));
      // OutlinedButton thick widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.error})?.width, equals(4));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.pressed})?.width, equals(4));
    });
    ...
    test('FCS7.103e GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      // ToggleButtons thin width
      expect(theme.toggleButtonsTheme.borderWidth, equals(1.5));
      // InputDecoration thin width
      final WidgetStateInputBorder? border = theme.inputDecorationTheme.border as WidgetStateInputBorder?;
      expect(border?.resolve(<WidgetState>{WidgetState.disabled}).borderSide.width, equals(2.5));
      expect(border?.resolve(<WidgetState>{}).borderSide.width, equals(2.5));
      // InputDecoration thick width
      expect(border?.resolve(<WidgetState>{WidgetState.focused}).borderSide.width, equals(3.5));
      expect(border?.resolve(<WidgetState>{WidgetState.focused, WidgetState.error}).borderSide.width, equals(3.5));
      // The general width should not be defined since we used the specific ones
      expect(
        theme.inputDecorationTheme.border?.borderSide.width,
        // TODO(rydmike): This is not expected, why do we get this? Study it!
      ...
      // OutlinedButton thin widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.selected})?.width, equals(0.5));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.hovered})?.width, equals(0.5));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.disabled})?.width, equals(0.5));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.focused})?.width, equals(0.5));
      // OutlinedButton thick widths
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.error})?.width, equals(1.5));
      expect(theme.outlinedButtonTheme.style?.side?.resolve(<WidgetState>{WidgetState.pressed})?.width, equals(1.5));
    });
    ...
    test('FCS7.104a GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ThemeData theme =
          FlexColorScheme.light(
            scheme: FlexScheme.materialBaseline,
            useMaterial3: false,
            subThemesData: const FlexSubThemesData(tintedDisabledControls: true),
          ).toTheme;
    ...
    test('FCS7.104c GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ThemeData theme =
          FlexColorScheme.light(
            scheme: FlexScheme.materialBaseline,
            useMaterial3: false,
            subThemesData: const FlexSubThemesData(sliderValueTinted: true, sliderTrackHeight: 6),
          ).toTheme;
      expect(theme.sliderTheme.valueIndicatorColor, isSameColorAs(const Color(0xed2e2349)));
      expect(theme.sliderTheme.trackHeight, equals(6));
      expect(theme.sliderTheme.activeTrackColor, isSameColorAs(theme.colorScheme.primary));
    });
    test('FCS7.104c GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      expect(theme.sliderTheme.valueIndicatorColor, isSameColorAs(const Color(0xed37242a)));
      expect(theme.sliderTheme.trackHeight, equals(8));
      expect(theme.sliderTheme.activeTrackColor, isSameColorAs(theme.colorScheme.tertiary));
    });
    ...
    test('FCS7.105a GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      expect(theme.tooltipTheme.textStyle!.color, isSameColorAs(Colors.white));
      expect(theme.tooltipTheme.textStyle!.fontSize, equals(14));
    });
    test('FCS7.105b GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      final FlexColorScheme fcs = FlexColorScheme.dark(
        scheme: FlexScheme.materialBaseline,
        useMaterial3: false,
        subThemesData: const FlexSubThemesData(tooltipRadius: 12),
      );
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(
      ...
      expect(theme.tooltipTheme.textStyle!.color, equals(Colors.black));
      expect(theme.tooltipTheme.textStyle!.fontSize, equals(14));
    });
    test('FCS7.105c GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      expect(theme.tooltipTheme.textStyle!.color, equals(Colors.white));
      expect(theme.tooltipTheme.textStyle!.fontSize, equals(14));
    });
    test('FCS7.105d GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      final FlexColorScheme fcs = FlexColorScheme.dark(
        ...
        useMaterial3: false,
        tooltipsMatchBackground: true,
        subThemesData: const FlexSubThemesData(tooltipRadius: 12, tooltipOpacity: 0.5),
      );
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(
    ...
    test('FCS7.105e GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      expect(theme.tooltipTheme.textStyle!.color, equals(Colors.white));
      expect(theme.tooltipTheme.textStyle!.fontSize, equals(14));
      expect(theme.tooltipTheme.waitDuration, const Duration(seconds: 1));
      expect(theme.tooltipTheme.showDuration, const Duration(milliseconds: 2500));
    });
    ...
    test('FCS7.107a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.materialBaseline,
        useMaterial3: true,
        subThemesData: const FlexSubThemesData(useM2StyleDividerInM3: true),
      );
      final ThemeData theme = fcs.toTheme;
      expect(theme.dividerTheme.color, equals(const Color(0x1F000000)));
      expect(theme.dividerColor, equals(const Color(0x1F000000)));
    });
    test('FCS7.107b GIVEN a FlexColorScheme.dark with useMaterial3:true '
      ...
      final ThemeData theme = fcs.toTheme;
      expect(theme.dividerTheme.color, equals(const Color(0x1FFFFFFF)));
      expect(theme.dividerColor, equals(const Color(0x1FFFFFFF)));
    });
    test('FCS7.107c GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.materialBaseline,
        useMaterial3: true,
        subThemesData: const FlexSubThemesData(useM2StyleDividerInM3: false),
      );
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.dividerTheme.color, equals(null));
      expect(theme.dividerColor, equals(colorScheme.outlineVariant));
    });
    test('FCS7.108a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.tabBarTheme.unselectedLabelColor, equals(colorScheme.onSurface));
      expect(theme.tabBarTheme.labelColor, equals(colorScheme.primary));
    });
    test('FCS7.109a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.materialBaseline,
        useMaterial3: true,
        subThemesData: const FlexSubThemesData(sliderBaseSchemeColor: SchemeColor.secondaryContainer),
      );
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.sliderTheme.valueIndicatorColor, equals(colorScheme.secondaryContainer));
      expect(theme.sliderTheme.activeTrackColor, equals(colorScheme.secondaryContainer));
      expect(theme.sliderTheme.thumbColor, equals(colorScheme.secondaryContainer));
    });
    test('FCS7.109a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.sliderTheme.valueIndicatorColor, equals(colorScheme.inversePrimary));
      expect(theme.sliderTheme.activeTrackColor, equals(colorScheme.primaryContainer));
      expect(theme.sliderTheme.thumbColor, equals(colorScheme.primaryContainer));
    });
    test('FCS7.110a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ThemeData theme = fcs.toTheme;
      expect(theme.bottomAppBarTheme.elevation, equals(2));
    });
    test('FCS7.110a GIVEN a FlexColorScheme.light with useMaterial3:true '
        'and using not using subTheme and bottomAppBar elevation none', () {
      final FlexColorScheme fcs = FlexColorScheme.light(scheme: FlexScheme.materialBaseline, useMaterial3: true);
      final ThemeData theme = fcs.toTheme;
      expect(theme.bottomAppBarTheme.elevation, equals(null));
    });
    test('FCS7.111a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.appBarTheme.backgroundColor, equals(colorScheme.surface.withValues(alpha: 0.5)));
    });
    test('FCS7.111b GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.appBarTheme.backgroundColor, equals(colorScheme.primary.withValues(alpha: 0.5)));
    });
    ...
    test('FCS7.111e GIVEN a FlexColorScheme.light with useMaterial3:false '
        ...
        'EXPECT bottom appbar background with primary opacity 0.5', () {
      final FlexColorScheme fcs = FlexColorScheme.light(
        colors: const FlexSchemeColor(primary: Colors.blue, secondary: Colors.red),
        useMaterial3: false,
        appBarOpacity: 0.5,
        appBarStyle: FlexAppBarStyle.custom,
      );
    ...
    test('FCS7.111f GIVEN a FlexColorScheme.dark with useMaterial3:false '
      ...
      final ThemeData theme = fcs.toTheme;
      final ColorScheme colorScheme = fcs.toScheme;
      expect(theme.appBarTheme.backgroundColor, equals(colorScheme.primary.withValues(alpha: 0.6)));
    });
    test('FCS7.112a GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.appBarTheme.shadowColor, equals(colorScheme.shadow));
      // BottomAppBar
      expect(theme.bottomAppBarTheme.surfaceTintColor, equals(Colors.transparent));
      // BottomSheet
      expect(theme.bottomSheetTheme.surfaceTintColor, equals(Colors.transparent));
      // Card
      expect(theme.cardTheme.surfaceTintColor, equals(Colors.transparent));
      // Chip
      expect(theme.chipTheme.surfaceTintColor, equals(Colors.transparent));
      // Dialog
      expect(theme.dialogTheme.surfaceTintColor, equals(Colors.transparent));
      expect(theme.dialogTheme.shadowColor, equals(colorScheme.shadow));
      // Drawer
      expect(theme.drawerTheme.surfaceTintColor, equals(Colors.transparent));
      expect(theme.drawerTheme.shadowColor, equals(colorScheme.shadow));
      // DropDownMenu
      expect(theme.dropdownMenuTheme.menuStyle!.surfaceTintColor!.resolve(<WidgetState>{}), equals(Colors.transparent));
      // MenuBar
      expect(theme.menuBarTheme.style!.surfaceTintColor!.resolve(<WidgetState>{}), equals(Colors.transparent));
      // Menu
      expect(theme.menuTheme.style!.surfaceTintColor!.resolve(<WidgetState>{}), equals(Colors.transparent));
      // NavigationBar
      expect(theme.navigationBarTheme.shadowColor, equals(colorScheme.shadow));
      // NavigationDrawer
      expect(theme.navigationDrawerTheme.surfaceTintColor, equals(Colors.transparent));
      expect(theme.navigationDrawerTheme.shadowColor, equals(colorScheme.shadow));
      // PopupMenuButton
    ...
    test('FCS7.112b GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      expect(theme.menuTheme.style!.surfaceTintColor!.resolve(<WidgetState>{}), equals(Colors.transparent));
      // NavigationBar
      expect(theme.navigationBarTheme.surfaceTintColor, equals(Colors.transparent));
      expect(theme.navigationBarTheme.shadowColor, equals(colorScheme.shadow));
      // NavigationDrawer
      expect(theme.navigationDrawerTheme.surfaceTintColor, equals(Colors.transparent));
      expect(theme.navigationDrawerTheme.shadowColor, equals(colorScheme.shadow));
    ...
    test('FCS7.112d GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      //
      // AppBar
      expect(theme.appBarTheme.surfaceTintColor, equals(null));
      expect(theme.appBarTheme.shadowColor, equals(null));
      // BottomAppBar
      expect(theme.bottomAppBarTheme.surfaceTintColor, equals(null));
      // BottomSheet
      expect(theme.bottomSheetTheme.surfaceTintColor, equals(null));
      // Card
      expect(theme.cardTheme.surfaceTintColor, equals(null));
      // Chip
      expect(theme.chipTheme.surfaceTintColor, equals(null));
      // Dialog
      expect(theme.dialogTheme.surfaceTintColor, equals(null));
      expect(theme.dialogTheme.shadowColor, equals(null));
      // Drawer
      expect(theme.drawerTheme.surfaceTintColor, equals(null));
      expect(theme.drawerTheme.shadowColor, equals(null));
      // DropDownMenu
      expect(theme.dropdownMenuTheme.menuStyle?.surfaceTintColor, equals(null));
      // MenuBar
      expect(theme.menuBarTheme.style?.surfaceTintColor, equals(null));
      // Menu
      expect(theme.menuTheme.style?.surfaceTintColor, equals(null));
      // NavigationBar
      expect(theme.navigationBarTheme.surfaceTintColor, equals(null));
      expect(theme.navigationBarTheme.shadowColor, equals(null));
      // NavigationDrawer
      expect(theme.navigationDrawerTheme.surfaceTintColor, equals(null));
      expect(theme.navigationDrawerTheme.shadowColor, equals(null));
      // PopupMenuButton
      expect(theme.popupMenuTheme.surfaceTintColor, equals(null));
    });
  });
  ...
  group('FCS8: New v7 tests WITH FlexColorScheme.toTheme ', () {
    ...
    test('FCS8:1 GIVEN a FlexColorScheme.light with useMaterial3:true '
      ...
      final ColorScheme scheme = fcs.toScheme;
      final ThemeData theme = fcs.toTheme;
      expect(theme.typography, equals(Typography.material2021(platform: defaultTargetPlatform, colorScheme: scheme)));
      expect(theme.tabBarTheme.unselectedLabelColor, isSameColorAs(scheme.onSurfaceVariant));
    });
    test('FCS8:2 GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ColorScheme scheme = fcs.toScheme;
      final ThemeData theme = fcs.toTheme;
      expect(theme.tabBarTheme.unselectedLabelColor, isSameColorAs(scheme.tertiary.withValues(alpha: 0.7)));
    });
    test('FCS8:3 GIVEN a FlexColorScheme.light with useMaterial3:false '
      ...
      final ColorScheme scheme = fcs.toScheme;
      final ThemeData theme = fcs.toTheme;
      expect(theme.tabBarTheme.unselectedLabelColor, isSameColorAs(scheme.tertiaryContainer.withValues(alpha: 0.45)));
    });
  });
  ...
  group('FCS8: ISSUE-118-Light WITH FlexColorScheme.toTheme ', () {
    ...
    test('FCS-ISSUE-118-Light-M2: GIVEN a FlexColorScheme.light with defined '
      ...
      final ColorScheme scheme = fcs.toScheme;
      final ThemeData theme = fcs.toTheme;
      expect(scheme, equals(schemeLight));
      expect(theme.colorScheme, equals(schemeLight));
    });
    test('FCS-ISSUE-118-Dark-M2: GIVEN a FlexColorScheme.dark with defined '
      ...
      final ColorScheme scheme = fcs.toScheme;
      final ThemeData theme = fcs.toTheme;
      expect(scheme, equals(schemeDark));
      expect(theme.colorScheme, equals(schemeDark));
    });
  ...
  group('FCS9: Pass-through features WITH FlexColorScheme.toTheme ', () {
    ...
    test('FCS9.1: GIVEN a FlexColorScheme test materialTapTargetSize '
        'pass-through.', () {
      ThemeData theme = FlexColorScheme.light(materialTapTargetSize: MaterialTapTargetSize.padded).toTheme;
      expect(theme.materialTapTargetSize, equals(MaterialTapTargetSize.padded));
      theme = FlexThemeData.light(materialTapTargetSize: MaterialTapTargetSize.shrinkWrap);
      expect(theme.materialTapTargetSize, equals(MaterialTapTargetSize.shrinkWrap));
      theme = FlexColorScheme.dark(materialTapTargetSize: MaterialTapTargetSize.padded).toTheme;
      expect(theme.materialTapTargetSize, equals(MaterialTapTargetSize.padded));
      theme = FlexThemeData.dark(materialTapTargetSize: MaterialTapTargetSize.shrinkWrap);
      expect(theme.materialTapTargetSize, equals(MaterialTapTargetSize.shrinkWrap));
    });
    test('FCS9.2: GIVEN a FlexColorScheme test pageTransitionsTheme '
      ...
      ThemeData theme = FlexColorScheme.light(pageTransitionsTheme: transitionsTheme).toTheme;
      expect(theme.pageTransitionsTheme, equals(transitionsTheme));
      theme = FlexThemeData.light(pageTransitionsTheme: transitionsTheme);
      expect(theme.pageTransitionsTheme, equals(transitionsTheme));
      theme = FlexColorScheme.dark(pageTransitionsTheme: transitionsTheme).toTheme;
      expect(theme.pageTransitionsTheme, equals(transitionsTheme));
      theme = FlexThemeData.dark(pageTransitionsTheme: transitionsTheme);
      expect(theme.pageTransitionsTheme, equals(transitionsTheme));
    });
  });
  group('FCS10: Raw and minimal FlexColorScheme COLOR promise tests', () {
    ...
    test('FCS10.1: GIVEN a raw default FlexColorScheme test default colors.', () {
      final ThemeData theme = const FlexColorScheme(primary: Colors.red, useMaterial3: false).toTheme;
    ...
    test('FCS10.2: GIVEN a raw default FlexColorScheme test dialog override '
        'color and default.', () {
      final ThemeData theme =
          const FlexColorScheme(primary: Colors.red, dialogBackground: Colors.blue, useMaterial3: false).toTheme;
      expect(theme.brightness, equals(Brightness.light));
      expect(theme.primaryColor, equals(Colors.red));
      expect(theme.colorScheme.primary, equals(Colors.red));
      expect(theme.colorScheme.onPrimary, equals(Colors.white));
