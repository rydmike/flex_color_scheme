...
void main() {
  test('Continuous rectangle border scale and lerp', () {
    const SquircleBorder c10 = SquircleBorder(cornerRadius: 100.0);
    const SquircleBorder c15 = SquircleBorder(cornerRadius: 150.0);
    const SquircleBorder c20 = SquircleBorder(cornerRadius: 200.0);
