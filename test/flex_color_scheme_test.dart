...
void main() {
  ...
  group('FCS1: WITH FlexColorScheme ', () {
    ...
    final FlexColorScheme m5 = FlexColorScheme(
      ...
      useSubThemes: true,
      subThemesData: const FlexSubThemesData(cornerRadius: 20),
    );
