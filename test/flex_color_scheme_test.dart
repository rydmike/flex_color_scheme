...
void main() {
  ...
  group('FCS1: WITH FlexColorScheme ', () {
    ...
    test('FCS1.04c: GIVEN a FlexColorScheme.light created object with colors '
      ...
      expect(
        FlexColorScheme.light(useMaterial3: false, colors: FlexColor.schemes[FlexScheme.material]!.light),
        m1e2,
      );
      // Expect toTheme from them to full-fill same condition.
      expect(
