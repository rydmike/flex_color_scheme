...
void main() {
  ...
  group('FSTC1: WITH FlexSubThemesData ', () {
    ...
    const FlexSubThemesData m5 = FlexSubThemesData(
      ...
      drawerIndicatorBorderRadius: 12,
    ...
    test(
      ...
      expect(
        ...
        equals(m4.copyWith(
          ...
          useFlutterDefaults: true,
          //
          useElevationTint: FlexTint.removeTint,
          useElevationShadow: FlexShadow.adaptive,
          //
          blendTextTheme: false,
          useTextTheme: true,
          useM2StyleDividerInM3: true,
