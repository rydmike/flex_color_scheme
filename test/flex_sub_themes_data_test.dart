...
void main() {
  ...
  group('FSTC1: WITH FlexSubThemesData ', () {
    ...
    const FlexSubThemesData m5 = FlexSubThemesData(
      ...
      adaptiveSplashType: FlexAdaptive.apple(),
      //
      splashType: FlexSplashType.inkRipple,
      splashTypeAdaptive: FlexSplashType.inkHighLight,
      //
      blendTextTheme: true,
      useTextTheme: false,
      useM2StyleDividerInM3: true,
    ...
    test(
      ...
      expect(
        ...
        equals(m4.copyWith(
          ...
          adaptiveSplashType: const FlexAdaptive.apple(),
          //
          splashType: FlexSplashType.inkRipple,
          splashTypeAdaptive: FlexSplashType.inkHighLight,
          //
