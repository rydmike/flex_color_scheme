...
void main() {
  ...
  group('WITH: FlexSubTheme.appBarTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'AppBar FST1: GIVEN a FlexSubTheme.appBarTheme() '
        'EXPECT equal to ...',
        () {});
  });
  group('WITH: FlexSubTheme.bottomAppBarTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'BottomAppBar FST1: GIVEN a FlexSubTheme.bottomAppBarTheme() '
        'EXPECT equal to ...',
        () {});
  });
  ...
  group('WITH: FlexSubTheme.drawerTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'Drawer FST1: GIVEN a FlexSubTheme.drawerTheme() '
        'EXPECT equal to ...',
        () {});
  });
  group('WITH: FlexSubTheme.dropdownMenuTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'DropdownMenu FST1: GIVEN a FlexSubTheme.dropdownMenuTheme() '
        'EXPECT equal to ...',
        () {});
  });
  ...
  group('WITH: FlexSubTheme.menuBarTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'MenuBar FST1: GIVEN a FlexSubTheme.menuBarTheme() '
        'EXPECT equal to ...',
        () {});
  });
  group('WITH: FlexSubTheme.menuButtonTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'MenuButton FST1: GIVEN a FlexSubTheme.menuButtonTheme() '
        'EXPECT equal to ...',
        () {});
  });
  group('WITH: FlexSubTheme.menuTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'MenuAnchor FST1: GIVEN a FlexSubTheme.menuTheme() '
        'EXPECT equal to ...',
        () {});
  });
  ...
  group('WITH: FlexSubTheme.navigationDrawerTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'NavigationDrawer FST1: GIVEN a FlexSubTheme.navigationDrawerTheme() '
        'EXPECT equal to ...',
        () {});
  });
  ...
  group('WITH: FlexSubTheme.segmentedButtonTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'SegmentedButton FST1: GIVEN a FlexSubTheme.segmentedButtonTheme() '
        'EXPECT equal to ...',
        () {});
  });
  ...
  group('WITH: FlexSubTheme.tabBarTheme ', () {
    ...
    // -------------------------------------------------------------------------
    test(
        'TabBar FST1: GIVEN a FlexSubTheme.tabBarTheme() '
        'EXPECT equal to ...',
        () {});
  });
