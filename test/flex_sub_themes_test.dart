...
void main() {
  ...
  group('WITH: FlexSubTheme.chipTheme ', () {
    ...
    // Expected: ChipThemeData:<ChipThemeData#d7392(backgroundColor: Color(0xffdfccfb), deleteIconColor: Color(0xff000000), disabledColor: Color(0x1f000000), selectedColor: Color(0xffbe96f8), secondarySelectedColor: Color(0xffbe96f8), surfaceTintColor: Color(0xff6200ee), checkMarkColor: Color(0xff000000), padding: EdgeInsets.all(4.0), shape: RoundedRectangleBorder(BorderSide(width: 0.0, style: none), BorderRadius.circular(8.0)), labelStyle: TextStyle(debugLabel: (blackMountainView labelLarge).copyWith, inherit: true, color: Color(0xff000000), family: Roboto, decoration: TextDecoration.none), secondaryLabelStyle: TextStyle(debugLabel: (blackMountainView labelLarge).copyWith, inherit: true, color: Color(0xff000000), family: Roboto, decoration: TextDecoration.none), iconTheme: IconThemeData#42c16(size: 18.0, color: Color(0xff6200ee)))>
    //   Actual: ChipThemeData:<ChipThemeData#75644(backgroundColor: Color(0xffdfccfb), deleteIconColor: Color(0xff000000), disabledColor: Color(0x1f000000), selectedColor: Color(0xffbe96f8), secondarySelectedColor: Color(0xffffffff), surfaceTintColor: Color(0xff6200ee), checkMarkColor: Color(0xff000000), padding: EdgeInsets.all(4.0), shape: RoundedRectangleBorder(BorderSide(width: 0.0, style: none), BorderRadius.circular(8.0)), labelStyle: TextStyle(debugLabel: (blackMountainView labelLarge).copyWith, inherit: true, color: Color(0xff000000), family: Roboto, decoration: TextDecoration.none), secondaryLabelStyle: TextStyle(debugLabel: (blackMountainView labelLarge).copyWith, inherit: true, color: Color(0xff000000), family: Roboto, decoration: TextDecoration.none), iconTheme: IconThemeData#42c16(size: 18.0, color: Color(0xff6200ee)))>
    test(
