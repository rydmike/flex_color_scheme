...
// ignore_for_file: only_throw_errors, avoid_catching_errors, comment_references, lines_longer_than_80_chars
...
class _PathMatcher extends Matcher {
  ...
  bool matches(Object? object, Map<dynamic, dynamic> matchState) {
    ...
    matchState[this] =
        'Not all the given points were inside or outside the path '
        'as expected:\n  ${errors.join("\n  ")}';
    return false;
  }
  ...
  Description describe(Description description) {
    ...
    return description
        .add('A Path that contains ${points(includes)} but does not '
            'contain ${points(excludes)}.');
  }
...
bool _evaluatePainter(Object? objectA, Canvas canvas, PaintingContext context) {
