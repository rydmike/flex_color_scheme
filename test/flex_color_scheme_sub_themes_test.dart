...
void main() {
  ...
  group('FCS8: WITH FlexColorScheme ', () {
    ...
    test('FCS8.001-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      expect(fcs.toTheme.appBarTheme.backgroundColor, equals(fcs.toTheme.colorScheme.secondaryContainer));
      expect(fcs.toTheme.indicatorColor, equals(fcs.toTheme.colorScheme.inversePrimary));
      expect(fcs.toTheme.tabBarTheme.labelColor, equals(fcs.toTheme.colorScheme.onSurfaceVariant));
      ...
      expect(fcsScheme.onSurface.red8bit > fcs.toTheme.textTheme.displayLarge!.color!.red8bit, equals(false));
    });
    ...
    test('FCS8.002-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      expect(fcsScheme.onSurface.red8bit <= fcsScheme.onSurface.red8bit, equals(true));
    });
    ...
    test('FCS8.004-light-a: GIVEN a FlexColorScheme raw with sub themes '
      ...
      final FlexColorScheme fcs = FlexColorScheme(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF4D31D7), brightness: Brightness.light),
        subThemesData: const FlexSubThemesData(
      ...
      expect(fcs.toTheme.appBarTheme.backgroundColor, equals(fcs.toTheme.colorScheme.secondary));
    });
    test('FCS8.004-light-b: GIVEN a FlexColorScheme raw with sub themes '
      ...
      expect(fcs.toTheme.appBarTheme.backgroundColor, equals(const Color(0xFF3DA3C2)));
    });
    test('FCS8.005-dark-a: GIVEN a FlexColorScheme raw with sub themes '
        'and AppBar scheme '
        'EXPECT sub-theme with given AppBar scheme color ', () {
      final FlexColorScheme fcs = FlexColorScheme(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF4D31D7), brightness: Brightness.dark),
        subThemesData: const FlexSubThemesData(
      ...
      expect(fcs.toTheme.appBarTheme.backgroundColor, equals(fcs.toTheme.colorScheme.tertiary));
    });
    test('FCS8.005-dark-b: GIVEN a FlexColorScheme raw with sub themes '
      ...
      expect(fcs.toTheme.appBarTheme.backgroundColor, equals(const Color(0xFF30454C)));
    });
    test('FCS8.006-light-a: GIVEN a FlexColorScheme.light with sub themes '
      ...
      expect(fcsTheme.navigationRailTheme.indicatorColor, isSameColorAs(fcsScheme.onTertiary.withValues(alpha: 0.5)));
      expect(
    ...
    test('FCS8.007-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ColorScheme fcsScheme = fcs.toScheme;
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.textSelectionTheme.cursorColor, equals(fcsScheme.primary));
      expect(fcsTheme.textSelectionTheme.selectionColor, isSameColorAs(fcsScheme.primary.withValues(alpha: 0.3)));
      expect(fcsTheme.textSelectionTheme.selectionHandleColor, isSameColorAs(fcsScheme.primary));
    });
    test('FCS8.008-dark: GIVEN a FlexColorScheme.dark with sub themes '
      ...
      final ColorScheme fcsScheme = fcs.toScheme;
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.textSelectionTheme.cursorColor, isSameColorAs(fcsScheme.primary));
      expect(fcsTheme.textSelectionTheme.selectionColor, isSameColorAs(fcsScheme.primary.withValues(alpha: 0.5)));
      expect(fcsTheme.textSelectionTheme.selectionHandleColor, isSameColorAs(fcsScheme.primary));
    });
    test('FCS8.009-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ColorScheme fcsScheme = fcs.toScheme;
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.textSelectionTheme.cursorColor, isSameColorAs(fcsScheme.tertiary));
      expect(fcsTheme.textSelectionTheme.selectionColor, isSameColorAs(fcsScheme.tertiary.withValues(alpha: 0.3)));
      expect(fcsTheme.textSelectionTheme.selectionHandleColor, isSameColorAs(fcsScheme.tertiary));
    });
    test('FCS8.010-dark: GIVEN a FlexColorScheme.dark with sub themes '
      ...
      final ColorScheme fcsScheme = fcs.toScheme;
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.textSelectionTheme.cursorColor, isSameColorAs(fcsScheme.secondary));
      expect(
        fcsTheme.textSelectionTheme.selectionColor,
        isSameColorAs(fcsScheme.onPrimaryContainer.withValues(alpha: 0.35)),
      );
      expect(fcsTheme.textSelectionTheme.selectionHandleColor, isSameColorAs(fcsScheme.onTertiaryContainer));
    });
    //
    test('FCS8.011-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.dialogTheme.shape, equals(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))));
    });
    test('FCS8.012-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.dialogTheme.shape, equals(RoundedRectangleBorder(borderRadius: BorderRadius.circular(20))));
    });
    //
    test('FCS8.013-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.splashFactory.toString(), "Instance of '_InstantSplashFactory'");
    });
    test('FCS8.014-light: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final ThemeData fcsTheme = fcs.toTheme;
      expect(fcsTheme.splashFactory.toString(), "Instance of '_InkRippleFactory'");
    });
    ...
    test('FCS8.015-prim: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.flutterDash,
        subThemesData: const FlexSubThemesData(appBarBackgroundSchemeColor: SchemeColor.primary),
    ...
    test('FCS8.015-sec: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.flutterDash,
        subThemesData: const FlexSubThemesData(appBarBackgroundSchemeColor: SchemeColor.secondary),
        keyColors: const FlexKeyColors(useSecondary: true, keepSecondary: true),
      );
      final ThemeData fcsTheme = fcs.toTheme;
      final ColorScheme scheme = fcs.toScheme;
    ...
    test('FCS8.015-tert: GIVEN a FlexColorScheme.light with sub themes '
      ...
      final FlexColorScheme fcs = FlexColorScheme.light(
        scheme: FlexScheme.flutterDash,
        subThemesData: const FlexSubThemesData(appBarBackgroundSchemeColor: SchemeColor.tertiary),
        keyColors: const FlexKeyColors(useTertiary: true, keepTertiary: true),
      );
      final ThemeData fcsTheme = fcs.toTheme;
      final ColorScheme scheme = fcs.toScheme;
