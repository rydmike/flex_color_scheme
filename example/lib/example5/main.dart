...
class _DemoAppState extends State<DemoApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // the definition below, times the surface style and app bar variants.
      ...
      // to strong blend. The app bar style has no effect here, nor the tooltip
      ...
      //
      // Toggling between the standard ThemeData.from and the
      ...
      //
      // In dark mode we can see many gaps in the resulting
      // ThemeData when using the standard ThemeData.from factory to create
      // the theme.
      // FlexColorScheme
    ...
    const Map<FlexAppBarStyle, Widget> themeAppBar = <FlexAppBarStyle, Widget>{
      ...
      FlexAppBarStyle.material: Padding(
        ...
        child: Text(
          ...
          // invisible soft hyphen. It can be used to guide text layout where it
          // can break a word to the next line, if it has to. On small phones
