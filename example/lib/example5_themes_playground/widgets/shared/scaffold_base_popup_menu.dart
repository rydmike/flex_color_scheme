...
///
/// Uses null [value] of [FlexScaffoldBaseColor] to represent and select
/// no selection of [FlexScaffoldBaseColor] which represents default
/// color behavior for the widget using the selected color.
///
...
class ScaffoldBasePopupMenu extends StatelessWidget {
  const ScaffoldBasePopupMenu({
    super.key,
    this.value,
    this.onChanged,
    this.enabled = true,
  ...
  /// The currently selected FlexScaffoldBaseColor value for this popup.
  ///
  /// A null value represents the default value selection.
  final FlexScaffoldBaseColor? value;

  /// Called when a new FlexScaffoldBaseColor is selected.
  ///
  /// The default value selection calls this with null value.
  /// The other with the choice corresponding to the selected enum value.
  final ValueChanged<FlexScaffoldBaseColor?>? onChanged;
