...
class BottomNavigationBarPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String labelForDefaultSelectedItem =
        isDark &&
            useMaterial3 &&
            ((controller.useFlexColorScheme && !controller.useSubThemes) || !controller.useFlexColorScheme)
        ? 'secondary'
        : 'primary';
            ...
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                defaultLabelDarkM2: controller.bottomNavigationBarElevation != 0
                    ...
                    : 'surface',
                defaultDisabledLabel: !controller.useSubThemes && controller.useFlexColorScheme
                    ? 'surface'
                    : 'ThemeData.canvasColor',
                defaultDisabledLabelDark: 'surface',
                defaultDisabledLabelDarkM2: !controller.useSubThemes && controller.useFlexColorScheme
                    ? 'surface, with dark elevation overlay'
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' pt',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.bottomNavigationBarSelectedLabelSize != null
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' dp',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.bottomNavigationBarSelectedIconSize != null
                    // ignore: string interpolation
