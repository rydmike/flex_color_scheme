    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Card(
          ...
          child: const Padding(padding: EdgeInsets.all(16.0), child: BottomNavigationBarShowcase(explain: false)),
        ),
        const SizedBox(height: 8),
            ...
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                subtitleReveal: const Text(
                  'In Material-2 dark mode, the bottom '
                ...
                colorSuffix:
                    isDark &&
                            !useMaterial3 &&
                            controller.bottomNavigationBarBackgroundSchemeColor == SchemeColor.surface &&
                            controller.bottomNavigationBarElevation != 0
                        ? ', with dark elevation overlay'
                        : '',
                defaultLabel: 'surface',
                defaultLabelDarkM2:
                    controller.bottomNavigationBarElevation != 0 ? 'surface, with dark elevation overlay' : 'surface',
                defaultDisabledLabel:
                    !controller.useSubThemes && controller.useFlexColorScheme ? 'surface' : 'ThemeData.canvasColor',
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                onChanged: controller.setBottomNavigationBarSelectedItemSchemeColor,
              ),
              lastWidget: SliderListTileReveal(
                enabled: enableControl,
                contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                onChanged: controller.setBottomNavigationBarUnselectedItemSchemeColor,
              ),
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: SwitchListTile(
                ...
                value: enableControl && controller.bottomNavigationBarShowSelectedLabels,
                onChanged:
                    controller.useSubThemes && controller.useFlexColorScheme
              ...
              lastWidget: SwitchListTile(
                ...
                value: enableControl && controller.bottomNavigationBarShowUnselectedLabels,
                onChanged:
                    controller.useSubThemes && controller.useFlexColorScheme
