            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'If you use any other labType than none and show the '
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: SwitchListTileReveal(
                ...
                onChanged: enableControl ? controller.setNavigationRailUseIndicator : null,
              ),
              lastWidget: SliderListTileReveal(
                contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
                enabled:
                    ...
                    !(!useMaterial3 && controller.navigationRailLabelType == NavigationRailLabelType.none),
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' pt',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.navigationRailSelectedLabelSize != null
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' dp',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.navigationRailSelectedIconSize != null
                    // ignore: string interpolation
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 16),
                  ColoredBox(color: theme.colorScheme.tertiaryContainer, child: const SizedBox(height: 60, width: 60)),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ColorSchemePopupMenu(
                    ...
                    defaultLabel: controller.navigationRailIndicatorSchemeColor == null
                        ? 'onSecondaryContainer'
                        : SchemeColor
                              .values[FlexSubThemes.onSchemeColor(controller.navigationRailIndicatorSchemeColor!).index]
                              .name,
                    ...
                    onChanged: controller.setNavigationRailSelectedIconSchemeColor,
                  ),
                  ColorSchemePopupMenu(
                    enabled: enableControl,
                    title: const Text('Selected label color'),
                    defaultLabel: controller.navigationRailBackgroundSchemeColor == null
                        ? 'onSurface'
                        : SchemeColor
                              .values[FlexSubThemes.onSchemeColor(controller.navigationRailBackgroundSchemeColor!)
                                  .index]
                              .name,
                    defaultDisabledLabel: 'onSurface',
                    defaultDisabledLabelM2: 'primary',
                    value: controller.navigationRailSelectedLabelSchemeColor,
                    onChanged: controller.setNavigationRailSelectedLabelSchemeColor,
                  ),
                  ColorSchemePopupMenu(
                    enabled: enableControl,
                    ...
                    onChanged: controller.setNavigationRailUnselectedItemSchemeColor,
                  ),
                  SwitchListTileReveal(
                    ...
                    value: enableControl ? controller.navigationRailMuteUnselectedItem : !enableControl,
                    onChanged: enableControl ? controller.setNavigationRailMuteUnselectedItem : null,
                  ),
                  const Divider(),
