...
class MenusPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String menuOnDefault = controller.menuSchemeColor == null && controller.menuItemBackgroundSchemeColor == null
        ? 'onSurface'
    ...
    final String menuOnIndicatorDefault =
        ...
        ? controller.menuItemBackgroundSchemeColor == null
              ? SchemeColor.values[FlexSubThemes.onSchemeColor(controller.menuSchemeColor!).index].name
              : SchemeColor.values[FlexSubThemes.onSchemeColor(controller.menuItemBackgroundSchemeColor!).index].name
        : SchemeColor.values[FlexSubThemes.onSchemeColor(controller.menuIndicatorBackgroundSchemeColor!).index].name;
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'The width of the DropdownMenu no longer by default '
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. FlexColorScheme version 8.3.0 includes a built-in '
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. This has been fixed in Flutter 3.27 and later.\n'
                      '\n'
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. The FIX PR, that also links the issues and the FIX '
