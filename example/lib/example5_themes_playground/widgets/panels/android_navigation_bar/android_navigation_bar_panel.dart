  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
          ...
          subtitleReveal: RichText(
            text: TextSpan(
              children: <TextSpan>[
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsSysNavDocs, text: 'documentation'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterIssue112301, text: 'umbrella issue #112301'),
                TextSpan(style: spanTextStyle, text: '. In earlier versions '),
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterIssue100027, text: 'issue #100027'),
                TextSpan(
                  style: spanTextStyle,
                  text:
        ...
        const ListTile(title: Text('Background opacity'), subtitle: Text('System navigation bar opacity')),
        ListTile(
