...
class SearchBarPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String defaultLabel = controller.searchRadius == null && effectiveRadius == null
        ? 'Stadium/28dp'
        : controller.searchRadius == null && effectiveRadius != null && controller.searchUseGlobalShape
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        ColorSchemePopupMenu(
          ...
          subtitleReveal: const Text(
            'If you use background color with '
        ...
        SliderListTileReveal(
          ...
          subtitleReveal: const Text(
            'In the Playground there is currently '
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'The InputDecoration theme leeks through into '
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. This issue has been fixed in Flutter 3.13.\n'
                      '\n'
