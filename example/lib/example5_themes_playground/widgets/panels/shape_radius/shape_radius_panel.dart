...
import 'package:flex_color_scheme_example/shared/widgets/universal/flex_stadium_squircle.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        EnumPopupMenu<AdaptiveResponse>(
          ...
          subtitleReveal: Text(
            controller.adaptiveResponseRadius?.describe ?? AdaptiveResponse.off.describe,
          ),
