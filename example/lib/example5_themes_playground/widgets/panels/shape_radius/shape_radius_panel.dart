...
class ShapeRadiusPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double radius = ThemeValues.effectiveRadius(controller) ?? (enableControl ? 12 : (useMaterial3 ? 12 : 4));
    ...
    return Column(
      ...
      children: <Widget>[
          ...
          child: Wrap(
            ...
            children: <Widget>[
              ...
              Material(
                clipBehavior: Clip.antiAlias,
                color: shapeColor,
                shape: ContinuousRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(radius))),
                child: SizedBox(
                  height: height,
                  width: width,
                  child: Center(
              ...
              Material(
                clipBehavior: Clip.antiAlias,
                color: shapeColor,
                shape: BeveledRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(radius))),
                child: SizedBox(
                  height: height,
                  width: width,
                  child: Center(
        ...
        EnumPopupMenu<AdaptiveResponse>(
          ...
          subtitleReveal: Text(controller.adaptiveResponseRadius?.describe ?? AdaptiveResponse.off.describe),
