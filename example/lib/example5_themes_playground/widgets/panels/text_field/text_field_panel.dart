...
class TextFieldPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double defaultBackgroundAlpha =
        useMaterial3
    ...
    //
    final double defaultSelectionOpacity =
        isLight
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        const Divider(),
        Padding(
          padding: EdgeInsetsDirectional.only(start: 16, end: useMaterial3 ? 24 : 16, bottom: 0),
          child: const TextFieldShowcase(),
        ),
        const Divider(),
        SwitchListTileReveal(
          enabled: enableControl,
          contentPadding: EdgeInsetsDirectional.only(start: 16, end: useMaterial3 ? 28 : 20),
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ListTileReveal(
                ...
                subtitle:
                    controller.inputDecoratorBorderType == FlexInputBorderType.outline && enableControl
                        ? const Text('Outlined')
        ...
        //
        if (isLight)
          ListTile(title: const Text('TextSelection style (light)'), tileColor: theme.colorScheme.surfaceContainer)
        else
          ListTile(title: const Text('TextSelection style (dark)'), tileColor: theme.colorScheme.surfaceContainer),
        const Divider(height: 0),
        const Padding(
          ...
          subtitleReveal: RichText(
            text: TextSpan(
              children: <TextSpan>[
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterHandleLimit, text: 'selectionHandleColor property'),
                TextSpan(
                  style: spanTextStyle,
                  text:
