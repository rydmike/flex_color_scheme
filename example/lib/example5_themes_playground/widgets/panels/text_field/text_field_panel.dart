...
import 'package:flex_color_scheme_example/example5_themes_playground/widgets/dialogs/set_text_field_to_defaults_dialog.dart';
import 'package:flex_color_scheme_example/example5_themes_playground/widgets/dialogs/set_text_field_to_dense_dialog.dart';
import 'package:flex_color_scheme_example/example5_themes_playground/widgets/dialogs/set_text_field_to_m3_dialog.dart';
import 'package:flex_color_scheme_example/example5_themes_playground/widgets/dialogs/set_text_field_to_outlined_dialog.dart';
...
class TextFieldPanel extends StatelessWidget {
  ...
  static String _adaptiveDecoratorRadiusLabel(ThemeController controller) {
    final bool useFCS = controller.useSubThemes && controller.useFlexColorScheme;
    if (!useFCS) {
      return '4 dp';
    }
  ...
  Widget build(BuildContext context) {
    ...
    final String unfocusedBorderDefaultLabel =
        controller.inputDecoratorBorderWidth == null && controller.thinBorderWidth == null
        ? '1 dp'
        : controller.inputDecoratorBorderWidth == null && controller.thinBorderWidth != null
        ? 'global ${controller.thinBorderWidth!.toStringAsFixed(1)} dp'
        : '';
    final String focusedBorderDefaultLabel =
        controller.inputDecoratorFocusedBorderWidth == null && controller.thickBorderWidth == null
        ? '2 dp'
        : controller.inputDecoratorFocusedBorderWidth == null && controller.thickBorderWidth != null
    ...
    final String decoratorRadiusDefaultLabel = controller.inputDecoratorBorderRadius == null && effectiveRadius == null
        ? useMaterial3
              ? '4 dp'
              : '10 dp'
    ...
    final String lightBackgroundLabel = enableControl && controller.inputDecoratorBackgroundAlphaLight != null
        ? '${controller.inputDecoratorBackgroundAlphaLight}'
        : '${defaultBackgroundAlpha.toInt()}';

    final String lightBackgroundLabelOpacity = enableControl && controller.inputDecoratorBackgroundAlphaLight != null
        ? (controller.inputDecoratorBackgroundAlphaLight! / 255 * 100).toStringAsFixed(1)
        : (defaultBackgroundAlpha / 255 * 100).toStringAsFixed(1);

    final String darkBackgroundLabel = enableControl && controller.inputDecoratorBackgroundAlphaDark != null
        ? '${controller.inputDecoratorBackgroundAlphaDark}'
        : useMaterial3
        ? '255' // #FF = 255 = 100% Dark M3 default
        : '20'; // #14 = 20 = 7.84% Dark FCS own M2 default

    final String darkBackgroundLabelOpacity = enableControl && controller.inputDecoratorBackgroundAlphaDark != null
        ? (controller.inputDecoratorBackgroundAlphaDark! / 255 * 100).toStringAsFixed(1)
        : (defaultBackgroundAlpha / 255 * 100).toStringAsFixed(1);
    ...
    final String selectionLabelDefaultOpacity = '${(defaultSelectionOpacity * 100).toStringAsFixed(0)} %';
    //
    final String baseDefaultLabelLightColor = controller.inputDecoratorSchemeColorLight != null
        ? SchemeColor.values[controller.inputDecoratorSchemeColorLight!.index].name
        : 'primary';
    final String baseDefaultLabelDarkColor = controller.inputDecoratorSchemeColorDark != null
        ? SchemeColor.values[controller.inputDecoratorSchemeColorDark!.index].name
        : 'primary';
    //
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        SwitchListTileReveal(
          ...
          subtitleReveal: const Text(
            'If you leave this OFF, you can still '
              ...
              return RowOrColumn(
                ...
                lastWidget: SliderListTileReveal(
                  ...
                  onChanged: (double? value) {
                    controller.setInputDecoratorBackgroundAlphaLight(value == null || value < 0 ? null : value.toInt());
                  },
                  min: 0,
                  max: 255,
                  divisions: 255,
            ...
            builder: (BuildContext context, bool isRow) {
              return RowOrColumn(
                ...
                lastWidget: SliderListTileReveal(
                  ...
                  onChanged: (double? value) {
                    controller.setInputDecoratorBackgroundAlphaDark(value == null || value < 0 ? null : value.toInt());
                  },
                  min: 0,
                  max: 255,
                  divisions: 255,
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ListTileReveal(
                ...
                subtitle: controller.inputDecoratorBorderType == FlexInputBorderType.outline && enableControl
                    ? const Text('Outlined')
                    : const Text('Underlined'),
                onTap: () {
                  if (controller.inputDecoratorBorderType == FlexInputBorderType.outline) {
                    controller.setInputDecoratorBorderType(FlexInputBorderType.underline);
                  } else {
                    controller.setInputDecoratorBorderType(FlexInputBorderType.outline);
                  }
                },
                trailing: Padding(
                  padding: const EdgeInsetsDirectional.only(end: 12),
                  child: controller.inputDecoratorBorderType == FlexInputBorderType.outline && enableControl
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: SwitchListTileReveal(
                ...
                onChanged: enableControl ? controller.setInputDecoratorUnfocusedHasBorder : null,
              ),
              lastWidget: SliderListTileReveal(
                contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
            ...
            return RowOrColumn(
              firstWidget: isLight
                  ...
                  ? ColorSchemePopupMenu(
                      ...
                      defaultLabelM2: controller.inputDecoratorSchemeColorLight?.name ?? 'primary',
                      defaultDisabledLabelM2: 'primary',
                      value: controller.inputDecoratorPrefixIconLightSchemeColor,
                      onChanged: controller.setInputDecoratorPrefixIconLightSchemeColor,
                    )
                  // 1st column dark
                  : ColorSchemePopupMenu(
                      contentPadding: ThemeValues.tilePaddingStart(context, isRow),
                      ...
                      title: const Text('Focused prefix icon'),
                      defaultLabel: 'onSurfaceVariant',
                      defaultLabelM2: controller.inputDecoratorSchemeColorDark?.name ?? 'primary',
                      defaultDisabledLabelM2: 'primary',
                      value: controller.inputDecoratorPrefixIconDarkSchemeColor,
                      onChanged: controller.setInputDecoratorPrefixIconDarkSchemeColor,
                    ),
              lastWidget: isLight
                  // 2nd column light
                  ? ColorSchemePopupMenu(
                      ...
                      onChanged: controller.setInputDecoratorSuffixIconLightSchemeColor,
                    )
                  // 2nd column dark
                  : ColorSchemePopupMenu(
                      enabled: enableControl,
                      ...
                      onChanged: controller.setInputDecoratorSuffixIconDarkSchemeColor,
                    ),
              isRow: isRow,
            );
          },
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'The text selection handle color cannot be changed '
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      ' for more information. consider making an '
