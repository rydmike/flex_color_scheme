        ...
        return Column(
          ...
          children: <Widget>[
                ...
                return RowOrColumn(
                  ...
                  firstWidget: SwitchListTileReveal(
                    ...
                    subtitleReveal: const Text(
                      ...
                      'LIGHT mode. This is the Material-3 spec standard used '
                      'by Flutter 3.47+ ColorScheme.fromSeed. It is more '
                      'color expressive, but reduces contrast.\n'
                      '\n'
                      'FlexColorScheme 9.0 defaults this ON so seeded light '
                      'themes match ColorScheme.fromSeed. Turn it OFF to keep '
                      'the older higher-contrast tone 10 on-container colors. '
                      'Flutter ColorScheme.fromSeed has no such opt-out.\n'
                      '\n'
                      'This modifier ONLY impacts LIGHT scheme variants where '
                      'the container on colors use tone 10. Dark mode already '
                      'uses expressive on-container tones (tone 90). For '
                      'scheme variants with an intentionally custom tone for '
                      'onColors on containers, this setting has no impact. '
                      'Such variants are:\n'
                      ' - Fidelity\n'
                      ' - Monochrome\n'
                      ' - Content\n'
                      ...
                      'normal contrast.\n'
                      '\n'
                      'When using FSS seed generated schemes, the tones '
            ...
            ListTileReveal(
              ...
              subtitleReveal: !widget.controller.useKeyColors || _isFlutterScheme
                  ? null
                  : const Text(
