...
class ProgressIndicatorPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String labelBaseDefault = controller.progressIndicatorBaseSchemeColor == null
        ? 'primary'
        : '${controller.progressIndicatorBaseSchemeColor?.name}';
    final String labelLinearTrackDefault = controller.progressIndicatorLinearTrackSchemeColor == null
        ? useMaterial3
              ? 'secondaryContainer'
              : 'background deprecated'
        : '${controller.progressIndicatorLinearTrackSchemeColor?.name}';
    final String labelCircularTrackDefault = controller.progressIndicatorCircularTrackSchemeColor == null
    ...
    final String labelRefreshBackgroundDefault = controller.progressIndicatorRefreshBackgroundSchemeColor == null
        ? 'canvasColor'
        : '${controller.progressIndicatorRefreshBackgroundSchemeColor?.name}';
    final String labelStopIndicatorDefault = controller.progressIndicatorStopIndicatorSchemeColor == null
        ? 'primary'
    ...
    final String labelTrackPaddingDefault = !use2023Style && useMaterial3 && !useZeroDefault ? '4 dp' : '0 dp';
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                onChanged: controller.setProgressIndicatorStopIndicatorSchemeColor,
              ),
              lastWidget: ColorSchemePopupMenu(
                contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
                enabled: enableControl,
                ...
                onChanged: controller.setProgressIndicatorRefreshBackgroundSchemeColor,
              ),
              isRow: isRow,
            );
          },
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: ColorSchemePopupMenu(
                ...
                onChanged: controller.setProgressIndicatorCircularTrackSchemeColor,
              ),
              lastWidget: EnumPopupMenu<StrokeCap>(
                contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
                enabled: enableControl,
                values: StrokeCap.values,
                defaultLabel: !use2023Style ? 'default (round)' : 'default (butt, animated=square)',
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              firstWidget: SliderListTileReveal(
                ...
                onChanged: controller.setProgressIndicatorCircularTrackPaddingStart,
                min: 0,
                max: 20,
                divisions: 40,
                valueDecimalPlaces: 1,
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                onChanged: controller.setProgressIndicatorCircularTrackPaddingBottom,
                min: 0,
                max: 20,
                divisions: 40,
                valueDecimalPlaces: 1,
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'If you set legacy style, year2023, to false and use '
