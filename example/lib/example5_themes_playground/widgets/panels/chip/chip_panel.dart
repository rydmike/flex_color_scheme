...
import 'package:flex_color_scheme_example/example5_themes_playground/widgets/panels/chip/chip_blend_colors_toggle_buttons.dart';
...
class ChipPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String chipRadiusDefaultLabel = controller.chipBorderRadius == null && effectiveRadius == null
        ? '8 dp'
