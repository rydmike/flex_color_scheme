          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: ColorSchemePopupMenu(
                ...
                defaultLabel: controller.navigationBarBackgroundSchemeColor == null
                    ? 'onSurface'
                    : SchemeColor
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' pt',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.navigationBarSelectedLabelSize != null
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SliderListTileReveal(
                ...
                valueUnitLabel: ' dp',
                valueDecimalPlaces: 0,
                valueDefaultLabel: controller.navigationBarSelectedIconSize != null
                    // ignore: string interpolation
