...
class ListTilePanel extends StatelessWidget {
  ...
  static final Uri _lisTilePlaceholderIssue = Uri(scheme: 'https', host: 'github.com', path: 'flutter/flutter/issues');
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'The minVertical padding is lowest at 4 not at 0 '
                      'This may be a bug in Flutter SDK. It will be studied '
                      'and reported as an ',
                ),
                LinkTextSpan(style: linkStyle, uri: _lisTilePlaceholderIssue, text: 'issue'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      ' if it is. The ListTileStyle theme property has no '
                      'effect, this may also be a bug in Flutter SDK. It will '
                      'be studied and reported as an ',
                ),
                LinkTextSpan(style: linkStyle, uri: _lisTilePlaceholderIssue, text: 'issue'),
                TextSpan(style: spanTextStyle, text: ' if it is one.\n'),
              ],
            ),
          ),
        ),
