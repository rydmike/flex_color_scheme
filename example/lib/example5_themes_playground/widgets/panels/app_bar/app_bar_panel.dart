...
class AppBarPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String titleLight = switch (controller.appBarStyleLight) {
      ...
      FlexAppBarStyle.material || FlexAppBarStyle.surface || FlexAppBarStyle.background => 'onSurface',
      FlexAppBarStyle.scaffoldBackground => appBarNeedsLight ? 'surface' : 'onSurface',
      FlexAppBarStyle.custom => 'surface',
      _ => useMaterial3 ? 'onSurface' : 'onPrimary',
    };
    final String titleDark = switch (controller.appBarStyleDark) {
      FlexAppBarStyle.primary => 'onPrimary',
      FlexAppBarStyle.scaffoldBackground => appBarNeedsLight ? 'onSurface' : 'surface',
      _ => 'onSurface',
    };
    ...
    final String actionIconLight = switch (controller.appBarStyleLight) {
      ...
      FlexAppBarStyle.background => useMaterial3 ? 'onSurfaceVariant' : 'onSurface',
              ...
              return RowOrColumn(
                firstWidget: AppBarStylePopupMenu(
                  ...
                  enabled:
                      ...
                      (controller.appBarBackgroundSchemeColorLight == null || !controller.useSubThemes),
                ...
                lastWidget: SliderListTileReveal(
                  ...
                  subtitleReveal: const Text(
                    'The themed opacity of the AppBar in light '
                    'mode, try 85% to 98%\n',
                  ),
            ...
            builder: (BuildContext context, bool isRow) {
              return RowOrColumn(
                firstWidget: AppBarStylePopupMenu(
                  ...
                  enabled:
                      controller.useFlexColorScheme &&
                      (controller.appBarBackgroundSchemeColorDark == null || !controller.useSubThemes),
                ...
                lastWidget: SliderListTileReveal(
                  ...
                  title: const Text('Opacity'),
                  subtitleReveal: const Text(
                    'The themed opacity of the AppBar in dark '
                    'mode, try 85% to 98%\n',
                  ),
            ...
            return RowOrColumn(
              firstWidget: isLight
                  ? ColorSchemePopupMenu(
                      ...
                      defaultDisabledLabel: controller.useFlexColorScheme ? 'AppBarStyle' : 'surface',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? 'AppBarStyle' : 'primary',
              ...
              lastWidget: isLight
                  ? ColorSchemePopupMenu(
                      ...
                      defaultLabel: controller.appBarBackgroundSchemeColorLight == null
                          ? titleLight
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorLight!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? titleLight : 'onSurface',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? titleLight : 'onPrimary',
                  ...
                  : ColorSchemePopupMenu(
                      ...
                      contentPadding: ThemeValues.tilePaddingEnd(context, isRow),
                      title: const Text('Title color'),
                      defaultLabel: controller.appBarBackgroundSchemeColorDark == null
                          ? titleDark
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorDark!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? titleDark : 'onSurface',
                  ...
                  ? ColorSchemePopupMenu(
                      ...
                      defaultLabel: controller.appBarBackgroundSchemeColorLight == null
                          ...
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorLight!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? leadingIconLight : 'onSurface',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? leadingIconLight : 'White',
                  ...
                  : ColorSchemePopupMenu(
                      ...
                      defaultLabel: controller.appBarBackgroundSchemeColorDark == null
                          ...
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorDark!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? leadingIconDark : 'onSurface',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? leadingIconDark : 'White',
                  ...
                  ? ColorSchemePopupMenu(
                      ...
                      defaultLabel: controller.appBarBackgroundSchemeColorLight == null
                          ...
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorLight!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? actionIconLight : 'onSurfaceVariant',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? actionIconLight : 'white',
                  ...
                  : ColorSchemePopupMenu(
                      ...
                      defaultLabel: controller.appBarBackgroundSchemeColorDark == null
                          ...
                          : SchemeColor
                                .values[FlexSubThemes.onSchemeColor(controller.appBarBackgroundSchemeColorDark!).index]
                                .name,
                      defaultDisabledLabel: controller.useFlexColorScheme ? actionIconDark : 'onSurfaceVariant',
                      defaultDisabledLabelM2: controller.useFlexColorScheme ? actionIconDark : 'White',
          ...
          builder: (BuildContext context, bool isRow) {
            return RowOrColumn(
              ...
              lastWidget: SwitchListTileReveal(
                ...
                value: controller.appBarTransparentStatusBar && controller.useFlexColorScheme,
                onChanged: controller.useFlexColorScheme ? controller.setAppBarTransparentStatusBar : null,
              ),
              isRow: isRow,
            );
          },
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'In Flutter 3.7 and earlier, when using '
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. This is fixed in 3.10 and later.\n'
                      '\n'
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      ', this is fixed in Flutter 3.13 and later.\n'
                      '\n'
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. The issue is still in effect in Flutter 3.35.1. '
