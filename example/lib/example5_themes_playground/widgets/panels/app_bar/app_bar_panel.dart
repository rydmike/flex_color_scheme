    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Card(
          ...
          child: const Padding(padding: EdgeInsets.all(16.0), child: AppBarShowcase()),
        ),
        if (isLight)
          ...
          subtitleReveal: RichText(
            text: TextSpan(
              children: <TextSpan>[
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterIssue110951, text: 'issue #110951'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterIssue123943, text: 'issue #123943'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                ...
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterIssue131042, text: 'issue #131042'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. The issue is still in effect in Flutter 3.24, '
