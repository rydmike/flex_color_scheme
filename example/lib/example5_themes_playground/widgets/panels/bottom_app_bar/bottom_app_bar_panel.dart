...
class BottomAppBarPanel extends StatelessWidget {
  ...
  static final Uri _fcsFlutterFix117082 = Uri(scheme: 'https', host: 'github.com', path: 'flutter/flutter/pull/117082');
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        const ListTileReveal(
          ...
          subtitleReveal: Text(
            'A BottomAppBar is typically used with '
        ...
        Card(
          ...
          child: const Padding(padding: EdgeInsets.all(16.0), child: BottomAppBarShowcase(explain: false)),
        ),
        const SizedBox(height: 8),
        if (isLight)
        ...
        const ListTileReveal(
          ...
          subtitleReveal: Text(
            'Flutter Material-2 mode original default color '
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'In Flutter 3.7 the BottomAppBar '
                      'color cannot be changed due to the issue described in ',
                ),
                LinkTextSpan(style: linkStyle, uri: _fcsFlutterFix117082, text: 'FIX PR #117082'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. The fix is available in Flutter 3.10 '
                      'and later.\n',
                ),
              ],
            ),
