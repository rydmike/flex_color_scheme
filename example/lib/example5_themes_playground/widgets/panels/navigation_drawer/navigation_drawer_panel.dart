...
class NavigationDrawerPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String drawerRadiusDefaultLabel = controller.drawerBorderRadius == null && effectiveRadius == null
        ? '16 dp'
        : controller.drawerBorderRadius == null && effectiveRadius != null
        ? 'global ${effectiveRadius.toStringAsFixed(0)}'
        : '';
    final String indicatorDefaultLabel = controller.drawerIndicatorBorderRadius == null && effectiveRadius == null
        ? 'stadium'
            ...
            text: TextSpan(
              children: <TextSpan>[
                ...
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. A few of them have been solved, but many '
