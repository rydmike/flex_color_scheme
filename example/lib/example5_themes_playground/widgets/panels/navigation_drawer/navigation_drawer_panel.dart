...
class NavigationDrawerPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String indicatorDefaultLabel =
        controller.drawerIndicatorBorderRadius == null && effectiveRadius == null
            ? 'stadium'
            : controller.drawerIndicatorBorderRadius == null && effectiveRadius != null
            ? 'global ${effectiveRadius.toStringAsFixed(0)}'
            : '';
    ...
    final double derivedIndicatorWidth = (controller.drawerWidth ?? (useMaterial3 ? 304 : 304)) - 2 * 12;
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        const ListTileReveal(
          title: Text('Drawer'),
          subtitleReveal: Text(
            'The Drawer comes in two variants, the vanilla '
        ...
        ListTileReveal(
          ...
          subtitleReveal: RichText(
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(style: spanTextStyle, text: 'Based on Material-3 '),
                LinkTextSpan(style: linkStyle, uri: _drawerM3Spec, text: 'specification of NavigationDrawer'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      ' it should be 360 dp wide, while Material-2 is '
                      '304 dp in Flutter. '
                ...
                LinkTextSpan(style: linkStyle, uri: _drawerWidthIssue123380, text: 'issue #123380'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      ' for more information and analysis of suitable '
        ...
        const ListTileReveal(
          ...
          subtitleReveal: Text(
            'The NavigationDrawer arrived with Flutter 3.7. '
              ...
              firstWidget: ColorSchemePopupMenu(
                ...
                defaultLabel:
                    controller.drawerIndicatorSchemeColor == null
                        ...
                        : SchemeColor
                            .values[FlexSubThemes.onSchemeColor(controller.drawerIndicatorSchemeColor!).index]
                            .name,
            ...
            text: TextSpan(
              children: <TextSpan>[
                TextSpan(
                  style: spanTextStyle,
                  text:
                      'The NavigationDrawer and its Indicator styling has a '
                ...
                LinkTextSpan(style: linkStyle, uri: _drawerUmbrellaIssue123507, text: 'issue #123507'),
                TextSpan(
                  style: spanTextStyle,
                  text:
                      '. A few of them have been solved, but most '
