...
String generateThemeDartCode(ThemeController controller) {
  ...
  final String fixedColorStyle = controller.fixedColorStyle != null && !controller.useKeyColors
  ...
  final String appBarOpacityLight = controller.appBarOpacityLight != null && controller.appBarOpacityLight != 1
      ? '    appBarOpacity: ${controller.appBarOpacityLight!.toStringAsFixed(2)},\n'
      : '';
  final String appBarOpacityDark = controller.appBarOpacityDark != null && controller.appBarOpacityDark != 1
  ...
  final String appBarElevationLight = controller.appBarElevationLight != 0 && controller.appBarElevationLight != null
      ? '    appBarElevation: ${controller.appBarElevationLight!.toStringAsFixed(1)},\n'
      : '';
  final String appBarElevationDark = controller.appBarElevationDark != 0 && controller.appBarElevationDark != null
      ? '    appBarElevation: ${controller.appBarElevationDark!.toStringAsFixed(1)},\n'
      : '';
  final String bottomAppBarElevationLight = controller.bottomAppBarElevationLight != null
      ? '    bottomAppBarElevation: ${controller.bottomAppBarElevationLight!.toStringAsFixed(1)},\n'
      : '';
  final String bottomAppBarElevationDark = controller.bottomAppBarElevationDark != null
  ...
  final String darkIsTrueBlack = controller.scaffoldDarkIsTrueBlack
      ...
      : '';
  final String swapLegacyOnMaterial3 = controller.swapLegacyColorsInM3 && controller.useMaterial3
  ...
  final String swapDarkColors = controller.swapPrimaryAndSecondaryDarkColors
      ...
      : '';
  final String tooltipsMatchBackground = controller.tooltipsMatchBackground && controller.tooltipSchemeColor == null
      ? '    tooltipsMatchBackground: ${controller.tooltipsMatchBackground},\n'
      : '';
  final String useM3ErrorColors = controller.useM3ErrorColors && !controller.useKeyColors
  ...
  final String blendDarkOnColors = controller.blendDarkOnColors
      ...
      : '';
  final String useMaterial3Typography = controller.useMaterial3Typography != null
      ? '      useMaterial3Typography: ${controller.useMaterial3Typography},\n'
      : '';
  final String useM2StyleDividerInM3 = controller.useM2StyleDividerInM3 && controller.useMaterial3
      ? '      useM2StyleDividerInM3: ${controller.useM2StyleDividerInM3},\n'
      : '';

  final String scaffoldBackgroundLightSchemeColor = controller.scaffoldBackgroundLightSchemeColor != null
      ? '      scaffoldBackgroundSchemeColor: ${controller.scaffoldBackgroundLightSchemeColor},\n'
      : '';
  final String scaffoldBackgroundDarkSchemeColor = controller.scaffoldBackgroundDarkSchemeColor != null
      ? '      scaffoldBackgroundSchemeColor: ${controller.scaffoldBackgroundDarkSchemeColor},\n'
      : '';

  final String scaffoldBackgroundLightBaseColor = controller.scaffoldBackgroundLightBaseColor != null
      ? '      scaffoldBackgroundBaseColor: ${controller.scaffoldBackgroundLightBaseColor},\n'
      : '';
  final String scaffoldBackgroundDarkBaseColor = controller.scaffoldBackgroundDarkBaseColor != null
  ...
  final String bottomSheetElevation = controller.bottomSheetElevation != null
      ...
      : '';
  final String bottomSheetModalElevation = controller.bottomSheetModalElevation != null
      ? '      bottomSheetModalElevation: ${controller.bottomSheetModalElevation!.toStringAsFixed(1)},\n'
      : '';
  final String bottomSheetBackgroundColor = controller.bottomSheetSchemeColor != null
      ? '      bottomSheetBackgroundColor: ${controller.bottomSheetSchemeColor},\n'
      : '';
  final String bottomSheetModalBackgroundColor = controller.bottomSheetSchemeColor != null
      ? '      bottomSheetModalBackgroundColor: ${controller.bottomSheetModalSchemeColor},\n'
      : '';
  final String bottomSheetClipBehavior = controller.bottomSheetClipBehavior != null
      ? '      bottomSheetClipBehavior: ${controller.bottomSheetClipBehavior},\n'
      : '';
  //
  // Material button sub themes border radius setup CODE.
  //
  final String textButtonBorderRadius = controller.textButtonBorderRadius != null
      ? '      textButtonRadius: ${controller.textButtonBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String filledButtonBorderRadius = controller.filledButtonBorderRadius != null
      ? '      filledButtonRadius: ${controller.filledButtonBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String elevatedButtonBorderRadius = controller.elevatedButtonBorderRadius != null
      ? '      elevatedButtonRadius: ${controller.elevatedButtonBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String outlinedButtonBorderRadius = controller.outlinedButtonBorderRadius != null
  ...
  final String elevatedButtonSecondarySchemeColor = controller.elevatedButtonSecondarySchemeColor == null
      ? ''
  ...
  final String outlinedButtonOutlineSchemeColor = controller.outlinedButtonOutlineSchemeColor == null
      ? ''
      : '      outlinedButtonOutlineSchemeColor: ${controller.outlinedButtonOutlineSchemeColor},\n';

  final String outlinedButtonBorderWidth = controller.outlinedButtonBorderWidth != null
      ? '      outlinedButtonBorderWidth: ${controller.outlinedButtonBorderWidth!.toStringAsFixed(1)},\n'
      : '';
  final String outlinedButtonPressedBorderWidth = controller.outlinedButtonPressedBorderWidth != null
  ...
  //
  final String toggleButtonsSchemeColor = controller.toggleButtonsSchemeColor == null
      ? ''
  ...
  final String toggleButtonsSelectedForegroundSchemeColor =
      ...
      : '';
  final String toggleButtonsUnselectedSchemeColor = controller.toggleButtonsUnselectedSchemeColor == null
      ? ''
      : '      toggleButtonsUnselectedSchemeColor: ${controller.toggleButtonsUnselectedSchemeColor},\n';
  final String toggleButtonsBorderSchemeColor = controller.toggleButtonsBorderSchemeColor == null
      ? ''
      : '      toggleButtonsBorderSchemeColor: ${controller.toggleButtonsBorderSchemeColor},\n';
  final String toggleButtonsBorderRadius = controller.toggleButtonsBorderRadius != null
      ? '      toggleButtonsRadius: ${controller.toggleButtonsBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String toggleButtonsBorderWidth = controller.toggleButtonsBorderWidth != null
      ? '      toggleButtonsBorderWidth: ${controller.toggleButtonsBorderWidth!.toStringAsFixed(1)},\n'
      : '';
  //
  // SegmentedButton sub themes setup CODE.
  //
  final String segmentedButtonSchemeColor = controller.segmentedButtonSchemeColor == null
      ? ''
  ...
  final String segmentedButtonSelectedForegroundSchemeColor =
      ...
      : '';
  final String segmentedButtonUnselectedSchemeColor = controller.segmentedButtonUnselectedSchemeColor == null
      ? ''
  ...
  final String segmentedButtonBorderSchemeColor = controller.segmentedButtonBorderSchemeColor == null
      ? ''
      : '      segmentedButtonBorderSchemeColor: ${controller.segmentedButtonBorderSchemeColor},\n';
  final String segmentedButtonBorderRadius = controller.segmentedButtonBorderRadius != null
      ? '      segmentedButtonRadius: ${controller.segmentedButtonBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String segmentedButtonBorderWidth = controller.segmentedButtonBorderWidth != null
  ...
  final String switchThumbSchemeColor = controller.switchThumbSchemeColor == null
      ? ''
  ...
  final String sliderThumbSchemeColor = controller.sliderThumbSchemeColor == null
      ? ''
      : '      sliderThumbSchemeColor: ${controller.sliderThumbSchemeColor},\n';
  final String sliderIndicatorSchemeColor = controller.sliderIndicatorSchemeColor == null
      ? ''
  ...
  final String sliderValueIndicatorType = controller.sliderValueIndicatorType == null
      ? ''
      : '      sliderValueIndicatorType: ${controller.sliderValueIndicatorType},\n';
  final String sliderShowValueIndicator = controller.sliderShowValueIndicator == null
      ? ''
  ...
  final String progressIndicatorYear2023 =
      controller.progressIndicatorYear2023 == null || (controller.progressIndicatorYear2023 ?? false)
      ? ''
      : '      progressIndicatorYear2023: ${controller.progressIndicatorYear2023},\n';
  final String progressIndicatorBaseSchemeColor = controller.progressIndicatorBaseSchemeColor == null
      ? ''
      : '      progressIndicatorBaseSchemeColor: ${controller.progressIndicatorBaseSchemeColor},\n';
  final String progressIndicatorLinearTrackSchemeColor = controller.progressIndicatorLinearTrackSchemeColor == null
      ? ''
      : '      progressIndicatorLinearTrackSchemeColor: ${controller.progressIndicatorLinearTrackSchemeColor},\n';
  final String progressIndicatorCircularTrackSchemeColor = controller.progressIndicatorCircularTrackSchemeColor == null
      ? ''
      : '      progressIndicatorCircularTrackSchemeColor: ${controller.progressIndicatorCircularTrackSchemeColor},\n';
  final String progressIndicatorRefreshBackgroundSchemeColor =
      controller.progressIndicatorRefreshBackgroundSchemeColor == null
      ? ''
      : '      progressIndicatorRefreshBackgroundSchemeColor: ${controller.progressIndicatorRefreshBackgroundSchemeColor},\n';
  final String progressIndicatorStopIndicatorSchemeColor = controller.progressIndicatorStopIndicatorSchemeColor == null
      ? ''
      : '      progressIndicatorStopIndicatorSchemeColor: ${controller.progressIndicatorStopIndicatorSchemeColor},\n';
  final String progressIndicatorLinearMinHeight = controller.progressIndicatorLinearMinHeight == null
      ? ''
      : '      progressIndicatorLinearMinHeight: ${controller.progressIndicatorLinearMinHeight},\n';
  final String progressIndicatorLinearRadius = controller.progressIndicatorLinearRadius == null
      ? ''
      : '      progressIndicatorLinearRadius: ${controller.progressIndicatorLinearRadius},\n';
  final String progressIndicatorStopIndicatorRadius = controller.progressIndicatorStopIndicatorRadius == null
      ? ''
      : '      progressIndicatorStopIndicatorRadius: ${controller.progressIndicatorStopIndicatorRadius},\n';
  final String progressIndicatorStrokeWidth = controller.progressIndicatorStrokeWidth == null
      ? ''
      : '      progressIndicatorStrokeWidth: ${controller.progressIndicatorStrokeWidth},\n';
  final String progressIndicatorStrokeAlign = controller.progressIndicatorStrokeAlign == null
      ? ''
      : '      progressIndicatorStrokeAlign: ${controller.progressIndicatorStrokeAlign?.toStringAsFixed(1) ?? '0'},\n';
  final String progressIndicatorTrackGap = controller.progressIndicatorTrackGap == null
      ? ''
      : '      progressIndicatorTrackGap: ${controller.progressIndicatorTrackGap?.toStringAsFixed(1) ?? '0'},\n';
  final String progressIndicatorStrokeCap = controller.progressIndicatorStrokeCap == null
      ? ''
      : '      progressIndicatorStrokeCap: ${controller.progressIndicatorStrokeCap},\n';
  final String progressConstraint = controller.progressIndicatorConstraints?.toStringAsFixed(0) ?? '';
  final String progressIndicatorConstraints = controller.progressIndicatorConstraints == null
      ? ''
      : '      progressIndicatorConstraints: BoxConstraints(minWidth: '
            '$progressConstraint, minHeight: $progressConstraint),\n';
  final String progressIndicatorCircularTrackPadding =
  ...
  //
  final String inputDecoratorSchemeColorLight = controller.inputDecoratorSchemeColorLight == null
      ? ''
      : '      inputDecoratorSchemeColor: ${controller.inputDecoratorSchemeColorLight},\n';
  final String inputDecoratorSchemeColorDark = controller.inputDecoratorSchemeColorDark == null
      ? ''
  ...
  final String inputDecoratorBackgroundAlphaLight = controller.inputDecoratorBackgroundAlphaLight == null
      ? ''
      : '      inputDecoratorBackgroundAlpha: ${controller.inputDecoratorBackgroundAlphaLight},\n';
  final String inputDecoratorBackgroundAlphaDark = controller.inputDecoratorBackgroundAlphaDark == null
      ? ''
      : '      inputDecoratorBackgroundAlpha: ${controller.inputDecoratorBackgroundAlphaDark},\n';
  final String inputDecoratorBorderType = controller.inputDecoratorBorderType == FlexInputBorderType.outline
  ...
  final String adaptiveInputDecoratorRadius =
      ...
      : '';
  final String inputDecoratorRadius = controller.inputDecoratorBorderRadius != null
      ? '      inputDecoratorRadius: ${controller.inputDecoratorBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String inputDecoratorRadiusAdaptive = controller.inputDecoratorBorderRadiusAdaptive != null
      ? '      inputDecoratorRadiusAdaptive: ${controller.inputDecoratorBorderRadiusAdaptive!.toStringAsFixed(1)},\n'
      : '';
  final String inputDecoratorUnfocusedHasBorder = controller.inputDecoratorUnfocusedHasBorder
      ? ''
      : '      inputDecoratorUnfocusedHasBorder: ${controller.inputDecoratorUnfocusedHasBorder},\n';
  final String inputDecoratorFocusedHasBorder = controller.inputDecoratorFocusedHasBorder
      ? ''
  ...
  final String inputDecoratorFocusedBorderWidth =
      ...
      : '';
  final String inputDecoratorPrefixIconSchemeColor = controller.inputDecoratorPrefixIconLightSchemeColor == null
      ? ''
      : '      inputDecoratorPrefixIconSchemeColor: ${controller.inputDecoratorPrefixIconLightSchemeColor},\n';
  final String inputDecoratorPrefixIconDarkSchemeColor = controller.inputDecoratorPrefixIconDarkSchemeColor == null
      ? ''
      : '      inputDecoratorPrefixIconSchemeColor: ${controller.inputDecoratorPrefixIconDarkSchemeColor},\n';
  final String inputDecoratorSuffixIconSchemeColor = controller.inputDecoratorSuffixIconLightSchemeColor == null
      ? ''
      : '      inputDecoratorSuffixIconSchemeColor: ${controller.inputDecoratorSuffixIconLightSchemeColor},\n';
  final String inputDecoratorSuffixIconDarkSchemeColor = controller.inputDecoratorSuffixIconDarkSchemeColor == null
      ? ''
      : '      inputDecoratorSuffixIconSchemeColor: ${controller.inputDecoratorSuffixIconDarkSchemeColor},\n';
  //
  // Text selection setup CODE.
  //
  final String inputCursorLightSchemeColor = controller.inputCursorLightSchemeColor == null
      ? ''
      : '      inputCursorSchemeColor: ${controller.inputCursorLightSchemeColor},\n';
  final String inputSelectionLightSchemeColor = controller.inputSelectionLightSchemeColor == null
      ? ''
      : '      inputSelectionSchemeColor: ${controller.inputSelectionLightSchemeColor},\n';
  final String inputSelectionLightOpacity = controller.inputSelectionLightOpacity == null
      ? ''
      : '      inputSelectionOpacity: ${controller.inputSelectionLightOpacity!.toStringAsFixed(2)},\n';
  final String inputSelectionHandleLightSchemeColor = controller.inputSelectionHandleLightSchemeColor == null
      ? ''
      : '      inputSelectionHandleSchemeColor: ${controller.inputSelectionHandleLightSchemeColor},\n';
  //
  final String inputCursorDarkSchemeColor = controller.inputCursorDarkSchemeColor == null
      ? ''
      : '      inputCursorSchemeColor: ${controller.inputCursorDarkSchemeColor},\n';
  final String inputSelectionDarkSchemeColor = controller.inputSelectionDarkSchemeColor == null
      ? ''
      : '      inputSelectionSchemeColor: ${controller.inputSelectionDarkSchemeColor},\n';
  final String inputSelectionDarkOpacity = controller.inputSelectionDarkOpacity == null
      ? ''
      : '      inputSelectionOpacity: ${controller.inputSelectionDarkOpacity!.toStringAsFixed(2)},\n';
  final String inputSelectionHandleDarkSchemeColor = controller.inputSelectionHandleDarkSchemeColor == null
      ? ''
  ...
  // ListTile setup CODE
  //
  final String listTileSelectedSchemeColor = controller.listTileSelectedSchemeColor != null
      ? '      listTileSelectedSchemeColor: ${controller.listTileSelectedSchemeColor},\n'
      : '';
  final String listTileIconSchemeColor = controller.listTileIconSchemeColor != null
      ? '      listTileIconSchemeColor: ${controller.listTileIconSchemeColor},\n'
      : '';
  final String listTileTextSchemeColor = controller.listTileTextSchemeColor != null
      ? '      listTileTextSchemeColor: ${controller.listTileTextSchemeColor},\n'
      : '';
  final String listTileTileSchemeColor = controller.listTileTileSchemeColor != null
      ? '      listTileTileSchemeColor: ${controller.listTileTileSchemeColor},\n'
      : '';
  final String listTileSelectedTileSchemeColor = controller.listTileSelectedTileSchemeColor != null
  ...
  final String listTileHorizontalTitleGap = controller.listTileHorizontalTitleGap != null
      ? '      listTileHorizontalTitleGap: ${controller.listTileHorizontalTitleGap!.toStringAsFixed(1)},\n'
      : '';
  final String listTileMinVerticalPadding = controller.listTileMinVerticalPadding != null
  ...
  final String listTileStyle = controller.listTileStyle != null
      ...
      : '';
  final String listTileTitleAlignment = controller.listTileTitleAlignment != null
  ...
  final String fabBorderRadius =
      ...
      : '';
  final String fabSchemeColor = controller.floatingActionButtonSchemeColor != null
      ? '      fabSchemeColor: ${controller.floatingActionButtonSchemeColor},\n'
      : '';
  final String fabForegroundSchemeColor = controller.floatingActionButtonForegroundSchemeColor != null
  ...
  final String snackBarElevation = controller.snackBarElevation != null
      ...
      : '';
  final String snackBarBackgroundSchemeColor = controller.snackBarSchemeColor != null
      ? '      snackBarBackgroundSchemeColor: ${controller.snackBarSchemeColor},\n'
      : '';
  final String snackBarActionSchemeColor = controller.snackBarActionSchemeColor != null
  ...
  final String chipSchemeColor = controller.chipSchemeColor != null
      ...
      : '';
  final String chipSelectedSchemeColor = controller.chipSelectedSchemeColor != null
      ? '      chipSelectedSchemeColor: ${controller.chipSelectedSchemeColor},\n'
      : '';
  final String chipSecondarySelectedSchemeColor = controller.chipSecondarySelectedSchemeColor != null
      ? '      chipSecondarySelectedSchemeColor: ${controller.chipSecondarySelectedSchemeColor},\n'
      : '';
  final String chipDeleteIconSchemeColor = controller.chipDeleteIconSchemeColor != null
  ...
  final String cardBorderRadius = controller.cardBorderRadius != null
      ...
      : '';
  final String cardBackgroundSchemeColor = controller.cardBackgroundSchemeColor != null
  ...
  final String cardBorderSchemeColor = controller.cardBorderSchemeColor != null
      ...
      : '';
  final String cardBorderWidth = controller.cardBorderWidth != null && controller.cardBorderSchemeColor != null
  ...
  final String popupMenuSchemeColor = controller.popupMenuSchemeColor != null
      ...
      : '';
  final String popupMenuOpacity = controller.popupMenuOpacity != 1 && controller.popupMenuOpacity != null
  ...
  final String tooltipSchemeColor = controller.tooltipSchemeColor != null
      ...
      : '';
  final String tooltipOpacity = controller.tooltipOpacity == 1.0 || controller.tooltipSchemeColor == null
      ? ''
      : '      tooltipOpacity: ${controller.tooltipOpacity},\n';
  //
  // Dialogs setup CODE
  //
  final String dialogBackgroundLightSchemeColor = controller.dialogBackgroundLightSchemeColor != null
      ? '      dialogBackgroundSchemeColor: ${controller.dialogBackgroundLightSchemeColor},\n'
      : '';
  final String dialogBackgroundDarkSchemeColor = controller.dialogBackgroundDarkSchemeColor != null
      ? '      dialogBackgroundSchemeColor: ${controller.dialogBackgroundDarkSchemeColor},\n'
      : '';
  final String useInputDecoratorThemeInDialogs = controller.useInputDecoratorThemeInDialogs
  ...
  final String dialogRadiusAdaptive =
      ...
      : '';
  final String datePickerHeaderBackgroundSchemeColor = controller.datePickerHeaderBackgroundSchemeColor != null
      ? '      datePickerHeaderBackgroundSchemeColor: ${controller.datePickerHeaderBackgroundSchemeColor},\n'
      : '';
  final String datePickerHeaderForegroundSchemeColor = controller.datePickerHeaderForegroundSchemeColor != null
      ? '      datePickerHeaderForegroundSchemeColor: ${controller.datePickerHeaderForegroundSchemeColor},\n'
      : '';
  final String datePickerDividerSchemeColor = controller.datePickerDividerSchemeColor != null
      ? '      datePickerDividerSchemeColor: ${controller.datePickerDividerSchemeColor},\n'
      : '';
  final String datePickerDialogRadius = controller.datePickerDialogBorderRadius != null
      ? '      datePickerDialogRadius: ${controller.datePickerDialogBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String timePickerDialogRadius = controller.timePickerDialogBorderRadius != null
      ? '      timePickerDialogRadius: ${controller.timePickerDialogBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String timePickerElementRadius = controller.timePickerElementRadius != null
  ...
  // AppBar setup CODE
  //
  final String appBarBackgroundSchemeColorLight = controller.appBarBackgroundSchemeColorLight != null
      ? '      appBarBackgroundSchemeColor: ${controller.appBarBackgroundSchemeColorLight},\n'
      : '';
  final String appBarBackgroundSchemeColorDark = controller.appBarBackgroundSchemeColorDark != null
      ? '      appBarBackgroundSchemeColor: ${controller.appBarBackgroundSchemeColorDark},\n'
      : '';
  final String appBarForegroundSchemeColorLight = controller.appBarForegroundSchemeColorLight != null
      ? '      appBarForegroundSchemeColor: ${controller.appBarForegroundSchemeColorLight},\n'
      : '';
  final String appBarForegroundSchemeColorDark = controller.appBarForegroundSchemeColorDark != null
      ? '      appBarForegroundSchemeColor: ${controller.appBarForegroundSchemeColorDark},\n'
      : '';

  final String appBarIconSchemeColorLight = controller.appBarIconSchemeColorLight != null
      ? '      appBarIconSchemeColor: ${controller.appBarIconSchemeColorLight},\n'
      : '';
  final String appBarIconSchemeColorDark = controller.appBarIconSchemeColorDark != null
      ? '      appBarIconSchemeColor: ${controller.appBarIconSchemeColorDark},\n'
      : '';
  final String appBarActionsIconSchemeColorLight = controller.appBarActionsIconSchemeColorLight != null
      ? '      appBarActionsIconSchemeColor: ${controller.appBarActionsIconSchemeColorLight},\n'
      : '';
  final String appBarActionsIconSchemeColorDark = controller.appBarActionsIconSchemeColorDark != null
      ? '      appBarActionsIconSchemeColor: ${controller.appBarActionsIconSchemeColorDark},\n'
      : '';

  final String appBarScrolledUnderElevationLight = controller.appBarScrolledUnderElevationLight != null
      ? '      appBarScrolledUnderElevation: ${controller.appBarScrolledUnderElevationLight!.toStringAsFixed(1)},\n'
      : '';
  final String appBarScrolledUnderElevationDark = controller.appBarScrolledUnderElevationDark != null
  ...
  //
  final String bottomAppBarSchemeColorLight = controller.bottomAppBarSchemeColorLight != null
      ? '      bottomAppBarSchemeColor: ${controller.bottomAppBarSchemeColorLight},\n'
      : '';
  final String bottomAppBarSchemeColorDark = controller.bottomAppBarSchemeColorDark != null
  ...
  // TabBar setup CODE
  //
  final String tabBarItemSchemeColorLight = controller.tabBarItemSchemeColorLight != null
  ...
  final String tabBarUnselectedItemSchemeColorLight =
      ...
      : '';
  final String tabBarIndicatorSchemeColorLight = controller.tabBarIndicatorLight != null
      ? '      tabBarIndicatorSchemeColor: ${controller.tabBarIndicatorLight},\n'
      : '';
  final String tabBarItemSchemeColorDark = controller.tabBarItemSchemeColorDark != null
  ...
  final String tabBarUnselectedItemSchemeColorDark =
      ...
      : '';
  final String tabBarIndicatorSchemeColorDark = controller.tabBarIndicatorDark != null
      ? '      tabBarIndicatorSchemeColor: ${controller.tabBarIndicatorDark},\n'
      : '';
  final String tabBarUnselectedItemOpacityLight = controller.tabBarUnselectedItemOpacityLight != null
      ? '      tabBarUnselectedItemOpacity: ${controller.tabBarUnselectedItemOpacityLight!.toStringAsFixed(2)},\n'
      : '';
  final String tabBarUnselectedItemOpacityDark = controller.tabBarUnselectedItemOpacityDark != null
  ...
  final String tabBarIndicatorWeight = controller.tabBarIndicatorWeight != null
      ...
      : '';
  final String tabBarIndicatorTopRadius = controller.tabBarIndicatorTopRadius != null
  ...
  final String tabBarTabAlignment = controller.tabBarTabAlignment != null
      ...
      : '';
  final String tabBarIndicatorAnimation = controller.tabBarIndicatorAnimation != null
  ...
  final String drawerElevation = controller.drawerElevation != null
      ...
      : '';
  final String drawerBackgroundSchemeColor = controller.drawerBackgroundSchemeColor != null
  ...
  final String drawerIndicatorWidth = controller.drawerIndicatorWidth != null
      ...
      : '';
  final String drawerIndicatorBorderRadius = controller.drawerIndicatorBorderRadius != null
      ? '      drawerIndicatorRadius: ${controller.drawerIndicatorBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String drawerIndicatorSchemeColor = controller.drawerIndicatorSchemeColor != null
  ...
  final String drawerIndicatorOpacity =
      ...
      : '';
  final String drawerSelectedItemSchemeColor = controller.drawerSelectedItemSchemeColor != null
      ? '      drawerSelectedItemSchemeColor: ${controller.drawerSelectedItemSchemeColor},\n'
      : '';
  final String drawerUnselectedItemSchemeColor = controller.drawerUnselectedItemSchemeColor != null
  ...
  final String bottomNavigationBarUnselectedLabelSchemeColor =
      ...
      : '';
  final String bottomNavigationBarMutedUnselectedLabel = controller.bottomNavigationBarMuteUnselectedItem != null
  ...
  final String bottomNavigationBarUnselectedIconSchemeColor =
      ...
      : '';
  final String bottomNavigationBarMutedUnselectedIcon = controller.bottomNavigationBarMuteUnselectedItem != null
      ? '      bottomNavigationBarMutedUnselectedIcon: ${controller.bottomNavigationBarMuteUnselectedItem},\n'
      : '';
  final String bottomNavigationBarBackgroundSchemeColor = controller.bottomNavigationBarBackgroundSchemeColor != null
  ...
  final String bottomNavigationBarOpacity =
      ...
      : '';
  final String bottomNavigationBarElevation = controller.bottomNavigationBarElevation != null
      ? '      bottomNavigationBarElevation: ${controller.bottomNavigationBarElevation!.toStringAsFixed(1)},\n'
      : '';
  final String bottomNavigationBarShowSelectedLabels = controller.bottomNavigationBarShowSelectedLabels
      ? ''
      : '      bottomNavigationBarShowSelectedLabels: ${controller.bottomNavigationBarShowSelectedLabels},\n';
  final String bottomNavigationBarShowUnselectedLabels = controller.bottomNavigationBarShowUnselectedLabels
      ? ''
      : '      bottomNavigationBarShowUnselectedLabels: ${controller.bottomNavigationBarShowUnselectedLabels},\n';
  final String bottomNavigationBarSelectedLabelSize = controller.bottomNavigationBarSelectedLabelSize != null
      ? '      bottomNavigationBarSelectedLabelSize: ${controller.bottomNavigationBarSelectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String bottomNavigationBarUnselectedLabelSize = controller.bottomNavigationBarUnselectedLabelSize != null
      ? '      bottomNavigationBarUnselectedLabelSize: ${controller.bottomNavigationBarUnselectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String bottomNavigationBarSelectedIconSize = controller.bottomNavigationBarSelectedIconSize != null
      ? '      bottomNavigationBarSelectedIconSize: ${controller.bottomNavigationBarSelectedIconSize!.toStringAsFixed(0)},\n'
      : '';
  final String bottomNavigationBarUnselectedIconSize = controller.bottomNavigationBarUnselectedIconSize != null
  ...
  final String menuSchemeColor = controller.menuSchemeColor != null
      ...
      : '';
  final String menuOpacity = controller.menuOpacity != null && controller.menuOpacity != 1
  ...
  final String menuPadding =
      ...
      : '';
  //
  final String menuBarBackgroundSchemeColor = controller.menuBarBackgroundSchemeColor != null
  ...
  final String menuBarShadowColor = controller.menuBarShadowColor != null
      ...
      : '';
  //
  final String menuItemBackgroundSchemeColor = controller.menuItemBackgroundSchemeColor != null
      ? '      menuItemBackgroundSchemeColor: ${controller.menuItemBackgroundSchemeColor},\n'
      : '';
  final String menuItemForegroundSchemeColor = controller.menuItemForegroundSchemeColor != null
      ? '      menuItemForegroundSchemeColor: ${controller.menuItemForegroundSchemeColor},\n'
      : '';
  final String menuIndicatorBackgroundSchemeColor = controller.menuIndicatorBackgroundSchemeColor != null
      ? '      menuIndicatorBackgroundSchemeColor: ${controller.menuIndicatorBackgroundSchemeColor},\n'
      : '';
  final String menuIndicatorForegroundSchemeColor = controller.menuIndicatorForegroundSchemeColor != null
  ...
  //
  final String searchBarBackgroundSchemeColor = controller.searchBackgroundSchemeColor != null
      ? '      searchBarBackgroundSchemeColor: ${controller.searchBackgroundSchemeColor!},\n'
      : '';
  final String searchViewBackgroundSchemeColor = controller.searchBackgroundSchemeColor != null
  ...
  final String searchViewRadius = controller.searchRadius != null
      ...
      : '';
  final String searchViewHeaderHeight = controller.searchViewHeaderHeight != null
  ...
  //
  final String navigationBarSelectedLabelSchemeColor = controller.navigationBarSelectedLabelSchemeColor != null
      ? '      navigationBarSelectedLabelSchemeColor: ${controller.navigationBarSelectedLabelSchemeColor},\n'
      : '';
  final String navigationBarUnselectedLabelSchemeColor = controller.navigationBarUnselectedItemSchemeColor != null
      ? '      navigationBarUnselectedLabelSchemeColor: ${controller.navigationBarUnselectedItemSchemeColor},\n'
      : '';
  final String navigationBarMutedUnselectedLabel = controller.navigationBarMuteUnselectedItem
      ? '      navigationBarMutedUnselectedLabel: ${controller.navigationBarMuteUnselectedItem},\n'
      : '';

  final String navigationBarSelectedIconSchemeColor = controller.navigationBarSelectedIconSchemeColor != null
      ? '      navigationBarSelectedIconSchemeColor: ${controller.navigationBarSelectedIconSchemeColor},\n'
      : '';
  final String navigationBarUnselectedIconSchemeColor = controller.navigationBarUnselectedItemSchemeColor != null
      ? '      navigationBarUnselectedIconSchemeColor: ${controller.navigationBarUnselectedItemSchemeColor},\n'
      : '';
  final String navigationBarMutedUnselectedIcon = controller.navigationBarMuteUnselectedItem
      ? '      navigationBarMutedUnselectedIcon: ${controller.navigationBarMuteUnselectedItem},\n'
      : '';

  final String navigationBarIndicatorSchemeColor = controller.navigationBarIndicatorSchemeColor != null
  ...
  final String navigationBarIndicatorOpacity =
      ...
      : '';
  final String navigationBarIndicatorRadius = controller.navigationBarIndicatorBorderRadius != null
      ? '      navigationBarIndicatorRadius: ${controller.navigationBarIndicatorBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String navigationBarBackgroundSchemeColor = controller.navigationBarBackgroundSchemeColor != null
      ? '      navigationBarBackgroundSchemeColor: ${controller.navigationBarBackgroundSchemeColor},\n'
      : '';
  final String navigationBarOpacity = controller.navigationBarOpacity != 1 && controller.navigationBarOpacity != null
      ? '      navigationBarOpacity: ${controller.navigationBarOpacity!.toStringAsFixed(2)},\n'
      : '';
  final String navigationBarElevation = controller.navigationBarElevation != null
  ...
  final String navigationBarLabelBehavior =
      ...
      : '';
  final String navigationBarSelectedLabelSize = controller.navigationBarSelectedLabelSize != null
      ? '      navigationBarSelectedLabelSize: ${controller.navigationBarSelectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationBarUnselectedLabelSize = controller.navigationBarUnselectedLabelSize != null
      ? '      navigationBarUnselectedLabelSize: ${controller.navigationBarUnselectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationBarSelectedIconSize = controller.navigationBarSelectedIconSize != null
      ? '      navigationBarSelectedIconSize: ${controller.navigationBarSelectedIconSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationBarUnselectedIconSize = controller.navigationBarUnselectedIconSize != null
  ...
  //
  final String navigationRailSelectedLabelSchemeColor = controller.navigationRailSelectedLabelSchemeColor != null
      ? '      navigationRailSelectedLabelSchemeColor: ${controller.navigationRailSelectedLabelSchemeColor},\n'
      : '';
  final String navigationRailUnselectedLabelSchemeColor = controller.navigationRailUnselectedItemSchemeColor != null
      ? '      navigationRailUnselectedLabelSchemeColor: ${controller.navigationRailUnselectedItemSchemeColor},\n'
      : '';
  final String navigationRailMutedUnselectedLabel = controller.navigationRailMuteUnselectedItem
      ? '      navigationRailMutedUnselectedLabel: ${controller.navigationRailMuteUnselectedItem},\n'
      : '';
  final String navigationRailSelectedIconSchemeColor = controller.navigationRailSelectedIconSchemeColor != null
      ? '      navigationRailSelectedIconSchemeColor: ${controller.navigationRailSelectedIconSchemeColor},\n'
      : '';
  final String navigationRailUnselectedIconSchemeColor = controller.navigationRailUnselectedItemSchemeColor != null
      ? '      navigationRailUnselectedIconSchemeColor: ${controller.navigationRailUnselectedItemSchemeColor},\n'
      : '';
  final String navigationRailMutedUnselectedIcon = controller.navigationRailMuteUnselectedItem
  ...
  final String navigationRailIndicatorOpacity =
      ...
      : '';
  final String navigationRailIndicatorRadius = controller.navigationRailIndicatorBorderRadius != null
      ? '      navigationRailIndicatorRadius: ${controller.navigationRailIndicatorBorderRadius!.toStringAsFixed(1)},\n'
      : '';
  final String navigationRailBackgroundSchemeColor = controller.navigationRailBackgroundSchemeColor != null
      ? '      navigationRailBackgroundSchemeColor: ${controller.navigationRailBackgroundSchemeColor},\n'
      : '';
  final String navigationRailOpacity = controller.navigationRailOpacity != 1 && controller.navigationRailOpacity != null
  ...
  final String navigationRailElevation =
      ...
      : '';
  final String navigationRailLabelType = controller.navigationRailLabelType != NavigationRailLabelType.none
      ? '      navigationRailLabelType: ${controller.navigationRailLabelType},\n'
      : '';
  final String navigationRailSelectedLabelSize = controller.navigationRailSelectedLabelSize != null
      ? '      navigationRailSelectedLabelSize: ${controller.navigationRailSelectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationRailUnselectedLabelSize = controller.navigationRailUnselectedLabelSize != null
      ? '      navigationRailUnselectedLabelSize: ${controller.navigationRailUnselectedLabelSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationRailSelectedIconSize = controller.navigationRailSelectedIconSize != null
      ? '      navigationRailSelectedIconSize: ${controller.navigationRailSelectedIconSize!.toStringAsFixed(0)},\n'
      : '';
  final String navigationRailUnselectedIconSize = controller.navigationRailUnselectedIconSize != null
  ...
  final String navigationRailGroupAlignment =
      ...
      : '';
  final String navigationRailMinWidth = controller.navigationRailMinWidth != null
      ? '      navigationRailMinWidth: ${controller.navigationRailMinWidth!.toStringAsFixed(0)},\n'
      : '';
  final String navigationRailMinExtendedWidth = controller.navigationRailMinExtendedWidth != null
  ...
  final String keepDarkPrimaryContainer = controller.keepDarkPrimaryContainer
      ...
      : '';
  final String keepDarkSecondaryContainer = controller.keepDarkSecondaryContainer
  ...
  final String useLegacyMonochromeSeedBehavior = controller.useLegacyMonochromeSeedBehavior
  ...
  if (controller.useKeyColors) {
    final String variantType = FlexSchemeVariant.values[controller.usedFlexToneSetup].isFlutterScheme
        ? '    variant: '
        : '    tones: ';
    final String variantTypeTonesLight = FlexSchemeVariant.values[controller.usedFlexToneSetup].isFlutterScheme
        ? ''
        : '\n        .tones(Brightness.light)';
    final String variantTypeTonesDark = FlexSchemeVariant.values[controller.usedFlexToneSetup].isFlutterScheme
        ? ''
  ...
  final String surfaceColorAdjustmentsLight =
      ...
      '$tintLightColor'
      '$lightIsWhite';
  final String headerSurfaceColorAdjustmentsLight = surfaceColorAdjustmentsLight == ''
      ? ''
  ...
  final String surfaceColorAdjustmentsDark =
      ...
      '$tintDarkColor'
      '$darkIsTrueBlack';
  final String headerSurfaceColorAdjustmentsDark = surfaceColorAdjustmentsDark == ''
      ? ''
      : '    // Surface color adjustments.\n';
