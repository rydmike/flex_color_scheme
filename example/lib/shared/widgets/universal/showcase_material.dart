      ...
      child: Column(
        children: <Widget>[
          ListTile(
            dense: true,
            title: Text(
              'RangeSlider stepped (${RangeLabels(
          ...
          ListTile(
            dense: true,
            title: Text(
              'RangeSlider continuous (${RangeLabels(
          ...
          ListTile(
            dense: true,
            title: Text(
              'RangeSlider stepped disabled (${RangeLabels(
                values.start.toStringAsFixed(0),
                values.end.toStringAsFixed(0),
              )})',
            ),
          ...
          ListTile(
            dense: true,
            title: Text(
              'RangeSlider continuous disabled (${RangeLabels(
                values.start.toStringAsFixed(2),
                values.end.toStringAsFixed(2),
              )})',
            ),
    ...
    return RepaintBoundary(
      child: PopupMenuButton<int>(
        ...
        itemBuilder: (BuildContext context) => const <PopupMenuItem<int>>[
          ...
          PopupMenuItem<int>(
            value: 2,
            child: ListTile(leading: Icon(Icons.cabin), title: Text('Wood cabin')),
          ),
          PopupMenuItem<int>(
            value: 3,
...
class _TextFieldShowcaseState extends State<TextFieldShowcase> {
  ...
  @override
  Widget build(BuildContext context) {
    final bool isDefaultDecoration = Theme.of(context).inputDecorationTheme == const InputDecorationThemeData();
              ...
              child: Material(
                ...
                child: SizedBox(
                  ...
                  child: AppBar(
                    ...
                    bottom: TabBar(
                      isScrollable: true,
                      tabAlignment: theme.tabBarTheme.tabAlignment == TabAlignment.fill
                          ? useM3
                      ...
                      tabs: <Widget>[
                        for (int i = 0; i < nrOfTabs; i++)
                          if (useM3) Tab(text: 'Tab label ${i + 1}') else Tab(text: 'TAB LABEL ${i + 1}'),
                      ],
                    ),
                  ),
                ),
...
class _SnackBarShowcaseState extends State<SnackBarShowcase> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color snackForeground = ThemeData.estimateBrightnessForColor(snackBackground) == Brightness.light
        ? Colors.black
        : Colors.white;
...
class _ShowTextStyle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String textBaseLine = style.textBaseline != null ? ' ${style.textBaseline}' : '';
    final String leadingDistribution = style.leadingDistribution != null ? '${style.leadingDistribution}' : '';
