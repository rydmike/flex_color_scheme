...
class NavigationBarLabelBehaviorToggleButtons extends StatelessWidget {
  const NavigationBarLabelBehaviorToggleButtons({super.key, this.labelBehavior, this.onChanged});
