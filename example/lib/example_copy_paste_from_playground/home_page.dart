      ...
      child: ResponsiveScaffold(
        ...
        body: ResponsiveCenter(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _MainPanel(themeMode: widget.themeMode, onThemeModeChanged: widget.onThemeModeChanged),
...
class _MainPanel extends StatefulWidget {
  const _MainPanel({required this.themeMode, required this.onThemeModeChanged});
    ...
    return HeaderCardStateful(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 16), child: ShowColorSchemeColors()),
          const Padding(padding: EdgeInsets.fromLTRB(16, 0, 16, 8), child: ShowThemeDataColors()),
        ],
      ),
    );
  }
