...
- [FlexColorScheme](#flexcolorscheme)
  - [> **A:** When tasks in previous answer are done :)](#-a-when-tasks-in-previous-answer-are-done-)
- [Contents](#contents)
...
> often need the colors in this `ColorScheme` when you create widget sub-themes
