...
///   [LinearProgressIndicator] via [progressIndicatorTheme].
...
abstract final class FlexSubThemes {
      ...
      side: WidgetStateBorderSide.fromMap(
        useM3
            ? <WidgetStatesConstraint, BorderSide?>{
                ...
                WidgetState.error:
                    BorderSide(width: 2.0, color: colorScheme.error),
                WidgetState.pressed: isBaseColor
                    ? BorderSide(width: 2.0, color: baseColor)
                    : BorderSide(width: 2.0, color: colorScheme.onSurface),
                WidgetState.hovered: isBaseColor
                    ? BorderSide(width: 2.0, color: baseColor)
                    : BorderSide(width: 2.0, color: colorScheme.onSurface),
                WidgetState.focused: isBaseColor
                    ? BorderSide(width: 2.0, color: baseColor)
                    : BorderSide(width: 2.0, color: colorScheme.onSurface),
                WidgetState.any: isBaseColor
                    ? BorderSide(width: 2.0, color: baseColor)
                    : BorderSide(
                        width: 2.0, color: colorScheme.onSurfaceVariant),
              }
            : <WidgetStatesConstraint, BorderSide?>{
                WidgetState.disabled & WidgetState.selected:
                    const BorderSide(width: 2.0, color: Colors.transparent),
                ...
                WidgetState.selected: BorderSide(width: 2.0, color: baseColor),
                WidgetState.any: isBaseColor
                    ? BorderSide(width: 2.0, color: baseColor)
                    : BorderSide(
                        width: 2.0,
      ...
      fillColor: WidgetStateProperty<Color>.fromMap(
        useM3
            ? <WidgetStatesConstraint, Color>{
                ...
                WidgetState.selected & WidgetState.error: colorScheme.error,
                WidgetState.selected: baseColor,
        ...
        useM3
            ? <WidgetStatesConstraint, Color>{
                WidgetState.disabled & WidgetState.selected:
                    colorScheme.surface,
                WidgetState.disabled: Colors.transparent,
                WidgetState.selected & WidgetState.error: colorScheme.onError,
                WidgetState.selected: onBaseColor,
                WidgetState.any: Colors.transparent,
              }
            : <WidgetStatesConstraint, Color>{
                ...
                WidgetState.selected: onBaseColor,
                WidgetState.any:
                    isLight ? Colors.grey.shade50 : Colors.grey.shade400,
              },
      ),
        ...
        style: ElevatedButton.styleFrom(
          ...
          overlayColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.hovered: tintInteract
                  ? tintedHovered(overlay, tint, factor)
                  : overlay.withAlpha(kAlphaHovered),
              WidgetState.focused: tintInteract
                  ? tintedFocused(overlay, tint, factor)
                  : overlay.withAlpha(kAlphaFocused),
              WidgetState.pressed: tintInteract
                  ? tintedPressed(overlay, tint, factor)
                  : overlay.withAlpha(kAlphaPressed),
              WidgetState.any: Colors.transparent,
            },
          ),
        ),
      ...
      if (baseSchemeColor != null || tintInteract || tintDisable) {
        ...
        overlayColor = WidgetStateProperty<Color?>.fromMap(
          <WidgetStatesConstraint, Color?>{
            WidgetState.hovered: tintInteract
                ? tintedHovered(overlay, tint, factor)
                : foreground.withAlpha(kAlphaHovered),
            WidgetState.focused: tintInteract
                ? tintedFocused(overlay, tint, factor)
                : foreground.withAlpha(kAlphaFocused),
            WidgetState.pressed: tintInteract
                ? tintedPressed(overlay, tint, factor)
                : foreground.withAlpha(kAlphaPressed),
      ...
      final WidgetStateProperty<double?>? elevationM3 = elevation == null
          ...
          : WidgetStateProperty<double?>.fromMap(
              <WidgetStatesConstraint, double?>{
                ...
                WidgetState.hovered: elevation + 2.0,
                WidgetState.focused: elevation,
                WidgetState.pressed: elevation,
  ...
  static FilledButtonThemeData filledButtonTheme({
    ...
    if (backgroundSchemeColor != null) {
      ...
      if (tintDisable) {
        backgroundColor = WidgetStateProperty<Color?>.fromMap(
          <WidgetStatesConstraint, Color?>{
            WidgetState.disabled: tintedDisable(
              colorScheme.onSurface,
              background,
            ).withAlpha(kAlphaVeryLowDisabled),
            WidgetState.any: null,
  ...
  static InputDecorationThemeData inputDecorationTheme({
    ...
    return InputDecorationThemeData(
      labelStyle: WidgetStateTextStyle.fromMap(
        <WidgetStatesConstraint, TextStyle>{
          ...
          WidgetState.error & WidgetState.hovered:
              ...
              TextStyle(color: colorScheme.error),
          WidgetState.error: TextStyle(color: colorScheme.error),
          WidgetState.focused: TextStyle(color: baseColor),
          WidgetState.hovered: TextStyle(color: colorScheme.onSurfaceVariant),
      ...
      iconColor: WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          WidgetState.disabled:
              tintDisable ? tintDisabledColor : disabledDefault,
          WidgetState.focused: useM3 ? colorScheme.onSurfaceVariant : baseColor,
          WidgetState.any:
              useM3 ? colorScheme.onSurfaceVariant : unfocusedIconDefaultM2,
        },
      ),
      prefixIconColor: WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          WidgetState.disabled:
              tintDisable ? tintDisabledColor : disabledDefault,
          WidgetState.focused: focusedPrefixIconColor,
          WidgetState.any:
              useM3 ? colorScheme.onSurfaceVariant : unfocusedIconDefaultM2,
        },
      ),
      suffixIconColor: WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          ...
          WidgetState.disabled:
              tintDisable ? tintDisabledColor : disabledDefault,
          WidgetState.focused: focusedSuffixIconColor,
          WidgetState.any:
              useM3 ? colorScheme.onSurfaceVariant : unfocusedIconDefaultM2,
        },
      ),
  ...
  static NavigationBarThemeData navigationBarTheme({
    ...
    return NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty<TextStyle>.fromMap(
        <WidgetStatesConstraint, TextStyle>{
          WidgetState.selected:
              textStyle.copyWith(fontSize: labelSize, color: labelColor),
      ...
      iconTheme: WidgetStateProperty<IconThemeData>.fromMap(
        <WidgetStatesConstraint, IconThemeData>{
          WidgetState.selected: IconThemeData(size: iconSize, color: iconColor),
  ...
  static NavigationDrawerThemeData navigationDrawerTheme({
    ...
    return NavigationDrawerThemeData(
      ...
      labelTextStyle: WidgetStateProperty<TextStyle>.fromMap(
        <WidgetStatesConstraint, TextStyle>{
          WidgetState.selected: style.apply(color: onIndicatorColor),
          WidgetState.any: style.apply(color: onBackgroundColor),
        },
      ),
      iconTheme: WidgetStateProperty<IconThemeData>.fromMap(
        <WidgetStatesConstraint, IconThemeData>{
          WidgetState.selected:
              IconThemeData(size: 24.0, color: onIndicatorColor),
          WidgetState.any: IconThemeData(size: 24.0, color: onBackgroundColor),
        },
      ),
    );
  }
    ...
    if (outlineSchemeColor != null ||
      ...
      side = WidgetStateProperty<BorderSide?>.fromMap(
        <WidgetStatesConstraint, BorderSide?>{
          ...
          WidgetState.error:
              BorderSide(color: colorScheme.error, width: pressedWidth),
          WidgetState.pressed:
              BorderSide(color: outlineColor, width: pressedWidth),
          WidgetState.any: BorderSide(color: outlineColor, width: normalWidth),
        },
      );
    }
      ...
      labelTextStyle: effectiveTextStyle != null
          ? WidgetStateProperty<TextStyle>.fromMap(
              <WidgetStatesConstraint, TextStyle>{
                ...
                WidgetState.any:
                    effectiveTextStyle.apply(color: foregroundColor),
              },
            )
          : null,
      shape: radius != null
        ...
        useM3
            ? <WidgetStatesConstraint, Color>{
                ...
                WidgetState.disabled: tintDisable
                    ? tintedDisable(colorScheme.onSurface, baseColor)
                    : colorScheme.onSurface.withAlpha(kAlphaDisabled),
                WidgetState.pressed: unselectedColored
                    ? baseColor.withAlpha(kAlphaUnselect)
                    : colorScheme.onSurface,
                WidgetState.hovered: unselectedColored
                    ? baseColor.withAlpha(kAlphaUnselect)
                    : colorScheme.onSurface,
                WidgetState.focused: unselectedColored
                    ? baseColor.withAlpha(kAlphaUnselect)
                    : colorScheme.onSurface,
      ...
      overlayColor: WidgetStateProperty<Color>.fromMap(
        <WidgetStatesConstraint, Color>{
          ...
          WidgetState.disabled: tintDisable
              ...
              : colorScheme.onSurface.withAlpha(kAlphaUltraLowDisabled),
          WidgetState.pressed: tintInteract
              ? tintedPressed(backgroundColor, tint, factor)
              : colorScheme.onSurface.withAlpha(kAlphaInputPressed),
          WidgetState.hovered: tintInteract
              ? tintedHovered(overlay, tint, factor)
              : colorScheme.onSurface.withAlpha(kAlphaHovered),
          WidgetState.any: Colors.transparent,
  ...
  static SegmentedButtonThemeData segmentedButtonTheme({
    ...
    final WidgetStateProperty<Color> foregroundColor =
      ...
      <WidgetStatesConstraint, Color>{
        WidgetState.disabled: tintDisable
            ? tintedDisable(disabledForeground, disableTint)
            : disabledForeground.withAlpha(kAlphaDisabled),
        WidgetState.selected: onSelectedColor,
        WidgetState.any: onUnselectedColor,
      },
    );
    ...
    return SegmentedButtonThemeData(
      style: ButtonStyle(
        ...
        backgroundColor: WidgetStateProperty<Color?>.fromMap(
          <WidgetStatesConstraint, Color?>{
            WidgetState.disabled:
                unselectedSchemeColor == null ? null : unselectedColor,
        ...
        overlayColor: WidgetStateProperty<Color?>.fromMap(
          <WidgetStatesConstraint, Color?>{
            WidgetState.selected & WidgetState.hovered: tintInteract
                ? tintedHovered(overlay, tint, factor)
                : unselectedColor.withAlpha(kAlphaHovered),
            WidgetState.selected & WidgetState.focused: tintInteract
                ? tintedFocused(overlay, tint, factor)
                : unselectedColor.withAlpha(kAlphaFocused),
            WidgetState.selected & WidgetState.pressed: tintInteract
                ? tintedPressed(overlay, tint, factor)
                : unselectedColor.withAlpha(kAlphaPressed),
            WidgetState.hovered: tintInteract
                ? tintedHovered(unOverlay, unTint, unFactor)
                : (unselectedSchemeColor == null
                    ? colorScheme.onSurface.withAlpha(kAlphaHovered)
                    : onUnselectedColor.withAlpha(kAlphaHovered)),
            WidgetState.focused: tintInteract
                ? tintedFocused(unOverlay, unTint, unFactor)
                : (unselectedSchemeColor == null
                    ? colorScheme.onSurface.withAlpha(kAlphaFocused)
                    : onUnselectedColor.withAlpha(kAlphaFocused)),
            WidgetState.pressed: tintInteract
                ? tintedPressed(unOverlay, unTint, unFactor)
                : (unselectedSchemeColor == null
                    ? colorScheme.onSurface.withAlpha(kAlphaPressed)
        ...
        side: WidgetStateProperty<BorderSide>.fromMap(
          <WidgetStatesConstraint, BorderSide>{
            ...
            WidgetState.any:
                BorderSide(color: borderColor, width: effectiveWidth),
          },
        ),
        shape: radius == null
            ? null
  ...
  static SnackBarThemeData snackBarTheme({
    ...
    return SnackBarThemeData(
      ...
      actionTextColor: WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          WidgetState.any:
              actionForeground ?? foreground?.withAlpha(0xDD) ?? Colors.grey,
        },
      ),
  ...
  static SwitchThemeData switchTheme({
    ...
    // Material-3 mode theming.
      ...
      if (useCupertinoStyle ?? false) {
        return SwitchThemeData(
          ...
          thumbIcon: const WidgetStateProperty<Icon?>.fromMap(
            <WidgetStatesConstraint, Icon?>{
              WidgetState.any: Icon(Icons.minimize, color: Colors.transparent),
            },
          ),
          trackOutlineColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.focused: HSLColor.fromColor(
          ...
          trackColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              ...
              WidgetState.selected: baseColor,
              WidgetState.any: isLight ? cup.color : cup.darkColor,
            },
          ),
          thumbColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.disabled: Colors.white.withValues(alpha: 0.5),
              WidgetState.any: Colors.white,
            },
          ),
          overlayColor: const WidgetStateProperty<Color?>.fromMap(
            <WidgetStatesConstraint, Color?>{
              WidgetState.any: Colors.transparent,
            },
          ),
          ...
          // wise a good match.
          trackOutlineWidth: const WidgetStateProperty<double?>.fromMap(
            <WidgetStatesConstraint, double?>{
              WidgetState.focused: 3.5,
              WidgetState.any: 0,
            },
          ),
          splashRadius: 0,
        ...
        final Color unselectedTrackColor = unselectedColored
            ? baseColor.withAlpha(
                isLight
        ...
        return SwitchThemeData(
          ...
          thumbColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.disabled & WidgetState.selected: colorScheme.surface,
              WidgetState.disabled: tintDisable
                  ? tintedDisable(colorScheme.onSurface, baseColor)
                  : colorScheme.onSurface.withAlpha(kAlphaDisabled),
              WidgetState.selected & WidgetState.pressed: thumbColor,
              WidgetState.selected & WidgetState.hovered: thumbColor,
              WidgetState.selected & WidgetState.focused: thumbColor,
              WidgetState.selected: onBaseColor,
          ...
          trackColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
              WidgetState.disabled & WidgetState.selected: tintDisable
                  ? tintedDisable(colorScheme.onSurface, baseColor)
                  : colorScheme.onSurface.withAlpha(kAlphaVeryLowDisabled),
              WidgetState.disabled: colorScheme.surfaceContainerHighest
                  .withAlpha(kAlphaVeryLowDisabled),
              WidgetState.selected & WidgetState.pressed: baseColor,
              WidgetState.selected & WidgetState.hovered: baseColor,
              WidgetState.selected & WidgetState.focused: baseColor,
              WidgetState.selected: baseColor,
              WidgetState.pressed: unselectedTrackColor,
              WidgetState.hovered: unselectedTrackColor,
              WidgetState.focused: unselectedTrackColor,
              WidgetState.any: unselectedTrackColor,
            },
          ),
          trackOutlineColor: WidgetStateProperty<Color>.fromMap(
            <WidgetStatesConstraint, Color>{
    ...
    return TabBarThemeData(
      ...
      overlayColor: useCustomOverlay
          ? WidgetStateProperty<Color?>.fromMap(
              <WidgetStatesConstraint, Color?>{
                WidgetState.selected & WidgetState.hovered:
                    overlayBase.withAlpha(kAlphaHovered),
                WidgetState.selected & WidgetState.focused:
                    overlayBase.withAlpha(kAlphaFocused),
                WidgetState.selected & WidgetState.pressed:
                    overlayBase.withAlpha(kAlphaPressed),
                WidgetState.selected: null,
                WidgetState.hovered: tintInteract
                    ? overlayBase.withAlpha(kAlphaHovered)
                    : colorScheme.onSurface.withAlpha(kAlphaHovered),
  ...
  static TimePickerThemeData timePickerTheme({
    ...
    Color defaultHourMinuteColor() {
      // coverage:ignore-start
      final Color selectedPressed = Color.alphaBlend(
        colorScheme.onPrimaryContainer,
        colorScheme.primaryContainer,
      );
      final Color selectedHovered = Color.alphaBlend(
        colorScheme.onPrimaryContainer.withValues(alpha: 0.08),
        colorScheme.primaryContainer,
      );
      final Color selectedFocused = Color.alphaBlend(
        colorScheme.onPrimaryContainer.withValues(alpha: 0.12),
        colorScheme.primaryContainer,
      );
      final Color selectedBase = colorScheme.primaryContainer;
      final Color unselectedPressed = Color.alphaBlend(
        colorScheme.onSurface,
        colorScheme.surfaceContainerHighest,
      );
      final Color unselectedHovered = Color.alphaBlend(
        colorScheme.onSurface.withValues(alpha: 0.08),
        colorScheme.surfaceContainerHighest,
      );
      final Color unselectedFocused = Color.alphaBlend(
        colorScheme.onSurface.withValues(alpha: 0.12),
        colorScheme.surfaceContainerHighest,
      );
      final Color unselectedBase = colorScheme.surfaceContainerHighest;
      // coverage:ignore-end

      return WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          WidgetState.selected & WidgetState.pressed: selectedPressed,
          WidgetState.selected & WidgetState.hovered: selectedHovered,
          WidgetState.selected & WidgetState.focused: selectedFocused,
          WidgetState.selected: selectedBase,
          WidgetState.pressed: unselectedPressed,
          WidgetState.hovered: unselectedHovered,
          WidgetState.focused: unselectedFocused,
          WidgetState.any: unselectedBase,
        },
      );
    }
    ...
    WidgetStateColor dayPeriodForegroundColor() {
      return WidgetStateColor.fromMap(
        <WidgetStatesConstraint, Color>{
          WidgetState.selected & WidgetState.pressed:
          ...
          WidgetState.focused: colorScheme.onSurfaceVariant,
          WidgetState.hovered: colorScheme.onSurfaceVariant,
          WidgetState.selected: colorScheme.onTertiaryContainer,
          WidgetState.any: colorScheme.onTertiaryContainer,
        },
      );
    }
    ...
    return TimePickerThemeData(
      ...
      dayPeriodColor: useM3
          ? WidgetStateColor.fromMap(
              <WidgetStatesConstraint, Color>{
                WidgetState.selected: colorScheme.tertiaryContainer,
                WidgetState.any: Colors.transparent,
              },
            )
          : null,
      dayPeriodTextColor: useM3 ? dayPeriodForegroundColor() : null,
      // M3 styling Flutter 3.7 does not do this yet, but we can du in M3 mode.
      hourMinuteColor: useM3
          ? WidgetStateColor.fromMap(
              <WidgetStatesConstraint, Color>{
                WidgetState.selected & WidgetState.pressed: Color.alphaBlend(
                  colorScheme.onPrimaryContainer,
                  colorScheme.primaryContainer,
                ),
                WidgetState.selected & WidgetState.focused: Color.alphaBlend(
                  colorScheme.onPrimaryContainer.withAlpha(kAlphaFocused),
                  colorScheme.primaryContainer,
                ),
                WidgetState.selected & WidgetState.hovered: Color.alphaBlend(
                  colorScheme.onPrimaryContainer.withAlpha(kAlphaHovered),
                  colorScheme.primaryContainer,
                ),
                WidgetState.selected: colorScheme.primaryContainer,
                WidgetState.pressed: Color.alphaBlend(
                  colorScheme.onSurface,
                  colorScheme.surfaceContainerHighest,
                ),
                WidgetState.focused: Color.alphaBlend(
                  colorScheme.onSurface.withAlpha(kAlphaFocused),
                  colorScheme.surfaceContainerHighest,
                ),
                WidgetState.hovered: Color.alphaBlend(
                  colorScheme.onSurface.withAlpha(kAlphaHovered),
                  colorScheme.surfaceContainerHighest,
                ),
                WidgetState.any: colorScheme.surfaceContainerHighest,
              },
            )
          : null,
      //
