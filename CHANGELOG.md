...
* Added more tests, now 658 tests. All color values used are now also tested, any modification to them is considered
...
- Version 1.4.0: Increased unit and widget test to 658 tests. All color definitions are now also tested to ensure 
