...
//     // We use the effective hue and the effectiveChroma, but chroma only if
//     // it is over the min level.
...
//     // like it is made as an FFI interface, works but odd in a Dart class.
...
// TODO(rydmike): Using CorePalette custom version for now.
// Using below custom version for now.
//
// This FlexCorePalette below is used to create a custom version of
// CorePalette with the needed [fromSeeds] factory that is
// a bit more efficient than the extended version above, because of reduced
// interface overhead. Keeping the extended code around above if it is needed
// later. Some more ramblings below.
//
...
/// An intermediate concept between the key color for a UI theme, and a full
/// color scheme. Five tonal palettes are generated + fixed error palette.
///
