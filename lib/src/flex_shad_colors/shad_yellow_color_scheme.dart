...
class ShadYellowColorScheme extends ShadColorScheme {
  /// Shadcn based Yellow color scheme, light.
  ...
  /// Shadcn based Yellow color scheme, dark.
  ...
  static const Color primaryForegroundLight = Color(0xff422006);
  ...
  static const Color primaryForegroundDark = Color(0xff422006);
  ...
  static const Color ringDark = Color(0xffa16207);
