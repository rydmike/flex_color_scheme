...
/// Shadcn based Grey color scheme.
@immutable
class ShadGrayColorScheme extends ShadColorScheme {
  /// Shadcn based Grey color scheme, light.
  ...
  /// Shadcn based Grey color scheme, dark.
  ...
  static const Color ringLight = Color(0xff030712);
  ...
  static const Color ringDark = Color(0xffd1d5db);
