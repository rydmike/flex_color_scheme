...
/// Shadcn based Orange color scheme.
@immutable
class ShadOrangeColorScheme extends ShadColorScheme {
  /// Shadcn based Orange color scheme, light.
  ...
  /// Shadcn based Orange color scheme, dark.
  ...
  static const Color ringLight = Color(0xfff97316);
  ...
  static const Color primaryForegroundDark = Color(0xfffafaf9);
  ...
  static const Color ringDark = Color(0xffea580c);
